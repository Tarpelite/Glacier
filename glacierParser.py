...
class GlacierParser ( Parser ):

    grammarFileName = "GlacierParser.g4"
    ...
    ruleNames =  [ "module", "module_content", "where_module", "module_body", 
                   ...
                   "pattern_synonym_lhs", "vars_hs", "cvars", "where_decls", 
                   ...
                   "tycl_context", "constr_context", "type_hs", "typedoc", 
                   ...
                   "tup_exprs", "commas_tup_tail", "tup_tail", "list_hs", 
                   "lexps", "flattenedpquals", "pquals", "squals", "transformqual", 
                   ...
                   "qconid", "conid", "qconsym", "consym", "literal", "open_hs", 
    ...
    class ModuleContext(ParserRuleContext):
        ...
        def EOF(self):
            return self.getToken(GlacierParser.EOF, 0)

        def module_content(self):
            return self.getTypedRuleContext(GlacierParser.Module_contentContext,0)


        def body(self):
            return self.getTypedRuleContext(GlacierParser.BodyContext,0)


        def OCURLY(self):
            return self.getToken(GlacierParser.OCURLY, 0)

        def semi(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.SemiContext)
            else:
                return self.getTypedRuleContext(GlacierParser.SemiContext,i)


        def pragmas(self):
            return self.getTypedRuleContext(GlacierParser.PragmasContext,0)


        def CCURLY(self):
            return self.getToken(GlacierParser.CCURLY, 0)

        def getRuleIndex(self):
            return GlacierParser.RULE_module
    ...
    def module(self):
        ...
        localctx = GlacierParser.ModuleContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if _la==GlacierParser.OCURLY:
                self.state = 512
                self.match(GlacierParser.OCURLY)
            ...
            if token in [GlacierParser.MODULE]:
                self.state = 530
                self.module_content()
                pass
            elif token in [GlacierParser.NEWLINE, GlacierParser.AS, GlacierParser.CASE, GlacierParser.CLASS, GlacierParser.DATA, GlacierParser.DEFAULT, GlacierParser.DERIVING, GlacierParser.DO, GlacierParser.HIDING, GlacierParser.IF, GlacierParser.IMPORT, GlacierParser.INFIX, GlacierParser.INFIXL, GlacierParser.INFIXR, GlacierParser.INSTANCE, GlacierParser.LET, GlacierParser.NEWTYPE, GlacierParser.QUALIFIED, GlacierParser.TYPE, GlacierParser.WILDCARD, GlacierParser.FOREIGN, GlacierParser.EXPORT, GlacierParser.MDO, GlacierParser.STDCALL, GlacierParser.CCALL, GlacierParser.CAPI, GlacierParser.JSCALL, GlacierParser.PATTERN, GlacierParser.STOCK, GlacierParser.ANYCLASS, GlacierParser.VIA, GlacierParser.LCASE, GlacierParser.Bang, GlacierParser.Minus, GlacierParser.Tilde, GlacierParser.DDollar, GlacierParser.Dollar, GlacierParser.Semi, GlacierParser.Quote, GlacierParser.DoubleQuote, GlacierParser.ReverseSlash, GlacierParser.AopenParen, GlacierParser.TopenTexpQuote, GlacierParser.TopenExpQuote, GlacierParser.TopenPatQuote, GlacierParser.TopenTypQoute, GlacierParser.TopenDecQoute, GlacierParser.OpenBoxParen, GlacierParser.OpenRoundBracket, GlacierParser.OpenSquareBracket, GlacierParser.CHAR, GlacierParser.STRING, GlacierParser.VARID, GlacierParser.CONID, GlacierParser.OpenPragmaBracket, GlacierParser.SEMI, GlacierParser.DECIMAL, GlacierParser.OCTAL, GlacierParser.HEXADECIMAL, GlacierParser.FLOAT]:
                self.state = 531
                self.body()
                pass
            else:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if _la==GlacierParser.CCURLY:
                self.state = 534
                self.match(GlacierParser.CCURLY)


            self.state = 538
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if _la==GlacierParser.Semi or _la==GlacierParser.SEMI:
                self.state = 537
                self.semi()


            self.state = 540
            self.match(GlacierParser.EOF)
    ...
    class Module_contentContext(ParserRuleContext):
        ...
        def MODULE(self):
            return self.getToken(GlacierParser.MODULE, 0)

        def modid(self):
            return self.getTypedRuleContext(GlacierParser.ModidContext,0)


        def where_module(self):
            return self.getTypedRuleContext(GlacierParser.Where_moduleContext,0)


        def exports(self):
            return self.getTypedRuleContext(GlacierParser.ExportsContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_module_content
    ...
    def module_content(self):
        ...
        localctx = GlacierParser.Module_contentContext(self, self._ctx, self.state)
        self.enterRule(localctx, 2, self.RULE_module_content)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 542
            self.match(GlacierParser.MODULE)
            self.state = 543
            self.modid()
            self.state = 545
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if _la==GlacierParser.OpenRoundBracket:
                self.state = 544
                self.exports()
    ...
    class Where_moduleContext(ParserRuleContext):
        ...
        def WHERE(self):
            return self.getToken(GlacierParser.WHERE, 0)

        def module_body(self):
            return self.getTypedRuleContext(GlacierParser.Module_bodyContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_where_module
    ...
    def where_module(self):
        ...
        localctx = GlacierParser.Where_moduleContext(self, self._ctx, self.state)
        self.enterRule(localctx, 4, self.RULE_where_module)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 549
            self.match(GlacierParser.WHERE)
            self.state = 550
            self.module_body()
        except RecognitionException as re:
            localctx.exception = re
    ...
    class Module_bodyContext(ParserRuleContext):
        ...
        def open_hs(self):
            return self.getTypedRuleContext(GlacierParser.Open_hsContext,0)
        ...
        def close(self):
            return self.getTypedRuleContext(GlacierParser.CloseContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_module_body
    ...
    def module_body(self):
        ...
        localctx = GlacierParser.Module_bodyContext(self, self._ctx, self.state)
    ...
    class PragmasContext(ParserRuleContext):
        ...
        def pragma(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.PragmaContext)
            else:
                return self.getTypedRuleContext(GlacierParser.PragmaContext,i)


        def getRuleIndex(self):
            return GlacierParser.RULE_pragmas
    ...
    def pragmas(self):
        ...
        localctx = GlacierParser.PragmasContext(self, self._ctx, self.state)
    ...
    class PragmaContext(ParserRuleContext):
        ...
        def language_pragma(self):
            return self.getTypedRuleContext(GlacierParser.Language_pragmaContext,0)


        def options_ghc(self):
            return self.getTypedRuleContext(GlacierParser.Options_ghcContext,0)


        def simple_options(self):
            return self.getTypedRuleContext(GlacierParser.Simple_optionsContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_pragma
    ...
    def pragma(self):
        ...
        localctx = GlacierParser.PragmaContext(self, self._ctx, self.state)
    ...
    class Language_pragmaContext(ParserRuleContext):
        ...
        def OpenPragmaBracket(self):
            return self.getToken(GlacierParser.OpenPragmaBracket, 0)

        def LANGUAGE(self):
            return self.getToken(GlacierParser.LANGUAGE, 0)

        def extension(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.ExtensionContext)
            else:
                return self.getTypedRuleContext(GlacierParser.ExtensionContext,i)


        def ClosePragmaBracket(self):
            return self.getToken(GlacierParser.ClosePragmaBracket, 0)

        def Comma(self, i:int=None):
            if i is None:
                return self.getTokens(GlacierParser.Comma)
            else:
                return self.getToken(GlacierParser.Comma, i)

        def semi(self):
            return self.getTypedRuleContext(GlacierParser.SemiContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_language_pragma
    ...
    def language_pragma(self):
        ...
        localctx = GlacierParser.Language_pragmaContext(self, self._ctx, self.state)
        self.enterRule(localctx, 12, self.RULE_language_pragma)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 571
            self.match(GlacierParser.OpenPragmaBracket)
            self.state = 572
            self.match(GlacierParser.LANGUAGE)
            self.state = 573
            self.extension()
            self.state = 578
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while _la==GlacierParser.Comma:
                self.state = 574
                self.match(GlacierParser.Comma)
                self.state = 575
                self.extension()
                self.state = 580
                self._errHandler.sync(self)
            ...
            self.state = 581
            self.match(GlacierParser.ClosePragmaBracket)
            self.state = 583
            self._errHandler.sync(self)
    ...
    class Options_ghcContext(ParserRuleContext):
        ...
        def OPTIONS_GHC(self):
            return self.getToken(GlacierParser.OPTIONS_GHC, 0)
        ...
        def Minus(self, i:int=None):
            if i is None:
                return self.getTokens(GlacierParser.Minus)
            else:
                return self.getToken(GlacierParser.Minus, i)
        ...
        def varid(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.VaridContext)
            else:
                return self.getTypedRuleContext(GlacierParser.VaridContext,i)


        def conid(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.ConidContext)
            else:
                return self.getTypedRuleContext(GlacierParser.ConidContext,i)


        def getRuleIndex(self):
            return GlacierParser.RULE_options_ghc
    ...
    def options_ghc(self):
        ...
        localctx = GlacierParser.Options_ghcContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(GlacierParser.OpenPragmaBracket)
            self.state = 586
            self.match(GlacierParser.OPTIONS_GHC)
            self.state = 594
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while _la==GlacierParser.Minus:
                self.state = 587
                self.match(GlacierParser.Minus)
                self.state = 590
                self._errHandler.sync(self)
                token = self._input.LA(1)
                if token in [GlacierParser.AS, GlacierParser.HIDING, GlacierParser.QUALIFIED, GlacierParser.EXPORT, GlacierParser.STDCALL, GlacierParser.CCALL, GlacierParser.CAPI, GlacierParser.JSCALL, GlacierParser.STOCK, GlacierParser.ANYCLASS, GlacierParser.VIA, GlacierParser.VARID]:
                    self.state = 588
                    self.varid()
                    pass
                elif token in [GlacierParser.CONID]:
                    self.state = 589
                    self.conid()
                    pass
                else:
    ...
    class Simple_optionsContext(ParserRuleContext):
        ...
        def OPTIONS(self):
            return self.getToken(GlacierParser.OPTIONS, 0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_simple_options
    ...
    def simple_options(self):
        ...
        localctx = GlacierParser.Simple_optionsContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(GlacierParser.OpenPragmaBracket)
            self.state = 602
            self.match(GlacierParser.OPTIONS)
            self.state = 610
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while _la==GlacierParser.Minus:
    ...
    class ExtensionContext(ParserRuleContext):
        ...
        def CONID(self):
            return self.getToken(GlacierParser.CONID, 0)

        def getRuleIndex(self):
            return GlacierParser.RULE_extension
    ...
    def extension(self):
        ...
        localctx = GlacierParser.ExtensionContext(self, self._ctx, self.state)
        self.enterRule(localctx, 18, self.RULE_extension)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 617
            self.match(GlacierParser.CONID)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
    ...
    class BodyContext(ParserRuleContext):
        ...
        def impdecls(self):
            return self.getTypedRuleContext(GlacierParser.ImpdeclsContext,0)


        def topdecls(self):
            return self.getTypedRuleContext(GlacierParser.TopdeclsContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_body
    ...
    def body(self):
        ...
        localctx = GlacierParser.BodyContext(self, self._ctx, self.state)
    ...
    class ImpdeclsContext(ParserRuleContext):
        ...
        def impdecl(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.ImpdeclContext)
            else:
                return self.getTypedRuleContext(GlacierParser.ImpdeclContext,i)


        def NEWLINE(self, i:int=None):
            if i is None:
                return self.getTokens(GlacierParser.NEWLINE)
            else:
                return self.getToken(GlacierParser.NEWLINE, i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_impdecls
    ...
    def impdecls(self):
        ...
        localctx = GlacierParser.ImpdeclsContext(self, self._ctx, self.state)
        ...
        try:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt == 1:
                    ...
                    self._errHandler.sync(self)
                    token = self._input.LA(1)
                    if token in [GlacierParser.IMPORT]:
                        self.state = 626
                        self.impdecl()
                        pass
                    elif token in [GlacierParser.NEWLINE]:
                        self.state = 627
                        self.match(GlacierParser.NEWLINE)
                        pass
                    elif token in [GlacierParser.Semi, GlacierParser.SEMI]:
                        self.state = 628
                        self.semi()
                        pass
                    else:
    ...
    class ExportsContext(ParserRuleContext):
        ...
        def OpenRoundBracket(self):
            return self.getToken(GlacierParser.OpenRoundBracket, 0)

        def CloseRoundBracket(self):
            return self.getToken(GlacierParser.CloseRoundBracket, 0)

        def exprt(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.ExprtContext)
            else:
                return self.getTypedRuleContext(GlacierParser.ExprtContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_exports
    ...
    def exports(self):
        ...
        localctx = GlacierParser.ExportsContext(self, self._ctx, self.state)
        self.enterRule(localctx, 24, self.RULE_exports)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 633
            self.match(GlacierParser.OpenRoundBracket)
            self.state = 642
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.AS) | (1 << GlacierParser.HIDING) | (1 << GlacierParser.MODULE) | (1 << GlacierParser.QUALIFIED) | (1 << GlacierParser.EXPORT) | (1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CAPI) | (1 << GlacierParser.JSCALL) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0) or ((((_la - 120)) & ~0x3f) == 0 and ((1 << (_la - 120)) & ((1 << (GlacierParser.OpenRoundBracket - 120)) | (1 << (GlacierParser.VARID - 120)) | (1 << (GlacierParser.CONID - 120)))) != 0):
                self.state = 634
                self.exprt()
                self.state = 639
                self._errHandler.sync(self)
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if _la==GlacierParser.Comma:
                self.state = 644
                self.match(GlacierParser.Comma)


            self.state = 647
            self.match(GlacierParser.CloseRoundBracket)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
    ...
    class ExprtContext(ParserRuleContext):
        ...
        def qvar(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.QvarContext)
            else:
                return self.getTypedRuleContext(GlacierParser.QvarContext,i)


        def qtycon(self):
            return self.getTypedRuleContext(GlacierParser.QtyconContext,0)
        ...
        def DoubleDot(self):
            return self.getToken(GlacierParser.DoubleDot, 0)
        ...
        def cname(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.CnameContext)
            else:
                return self.getTypedRuleContext(GlacierParser.CnameContext,i)
        ...
        def qtycls(self):
            return self.getTypedRuleContext(GlacierParser.QtyclsContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_exprt
    ...
    def exprt(self):
        ...
        localctx = GlacierParser.ExprtContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                if la_ == 1:
                    ...
                    self.match(GlacierParser.OpenRoundBracket)
                    self.state = 652
                    self.match(GlacierParser.DoubleDot)
                    self.state = 653
                    self.match(GlacierParser.CloseRoundBracket)
                    ...
                    self._errHandler.sync(self)
                    _la = self._input.LA(1)
                    if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.AS) | (1 << GlacierParser.HIDING) | (1 << GlacierParser.QUALIFIED) | (1 << GlacierParser.EXPORT) | (1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CAPI) | (1 << GlacierParser.JSCALL) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0) or ((((_la - 118)) & ~0x3f) == 0 and ((1 << (_la - 118)) & ((1 << (GlacierParser.OpenBoxParen - 118)) | (1 << (GlacierParser.OpenRoundBracket - 118)) | (1 << (GlacierParser.OpenSquareBracket - 118)) | (1 << (GlacierParser.VARID - 118)) | (1 << (GlacierParser.CONID - 118)))) != 0):
                        self.state = 655
                        self.cname()
                        self.state = 660
                        self._errHandler.sync(self)
                ...
                if la_ == 1:
                    ...
                    self._errHandler.sync(self)
                    _la = self._input.LA(1)
                    if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.AS) | (1 << GlacierParser.HIDING) | (1 << GlacierParser.QUALIFIED) | (1 << GlacierParser.EXPORT) | (1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CAPI) | (1 << GlacierParser.JSCALL) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0) or ((((_la - 120)) & ~0x3f) == 0 and ((1 << (_la - 120)) & ((1 << (GlacierParser.OpenRoundBracket - 120)) | (1 << (GlacierParser.VARID - 120)) | (1 << (GlacierParser.CONID - 120)))) != 0):
                        self.state = 673
                        self.qvar()
                        self.state = 678
                        self._errHandler.sync(self)
    ...
    class ImpdeclContext(ParserRuleContext):
        ...
        def IMPORT(self):
            return self.getToken(GlacierParser.IMPORT, 0)

        def modid(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.ModidContext)
            else:
                return self.getTypedRuleContext(GlacierParser.ModidContext,i)


        def QUALIFIED(self):
            return self.getToken(GlacierParser.QUALIFIED, 0)

        def AS(self):
            return self.getToken(GlacierParser.AS, 0)

        def impspec(self):
            return self.getTypedRuleContext(GlacierParser.ImpspecContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_impdecl
    ...
    def impdecl(self):
        ...
        localctx = GlacierParser.ImpdeclContext(self, self._ctx, self.state)
        self.enterRule(localctx, 28, self.RULE_impdecl)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 690
            self.match(GlacierParser.IMPORT)
            self.state = 692
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if _la==GlacierParser.QUALIFIED:
                self.state = 691
                self.match(GlacierParser.QUALIFIED)
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if _la==GlacierParser.AS:
                self.state = 695
                self.match(GlacierParser.AS)
                self.state = 696
                self.modid()
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if _la==GlacierParser.HIDING or _la==GlacierParser.OpenRoundBracket:
                self.state = 699
                self.impspec()
    ...
    class ImpspecContext(ParserRuleContext):
        ...
        def himport(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.HimportContext)
            else:
                return self.getTypedRuleContext(GlacierParser.HimportContext,i)
        ...
        def HIDING(self):
            return self.getToken(GlacierParser.HIDING, 0)

        def getRuleIndex(self):
            return GlacierParser.RULE_impspec
    ...
    def impspec(self):
        ...
        localctx = GlacierParser.ImpspecContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [GlacierParser.OpenRoundBracket]:
                self.enterOuterAlt(localctx, 1)
                self.state = 707
                self.match(GlacierParser.OpenRoundBracket)
                self.state = 719
                ...
                self.match(GlacierParser.CloseRoundBracket)
                pass
            elif token in [GlacierParser.HIDING]:
                self.enterOuterAlt(localctx, 2)
                self.state = 722
                self.match(GlacierParser.HIDING)
                self.state = 723
                self.match(GlacierParser.OpenRoundBracket)
                self.state = 735
                self._errHandler.sync(self)
    ...
    class HimportContext(ParserRuleContext):
        ...
        def var(self):
            return self.getTypedRuleContext(GlacierParser.VarContext,0)


        def tycon(self):
            return self.getTypedRuleContext(GlacierParser.TyconContext,0)
        ...
        def tycls(self):
            return self.getTypedRuleContext(GlacierParser.TyclsContext,0)


        def sig_vars(self):
            return self.getTypedRuleContext(GlacierParser.Sig_varsContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_himport
    ...
    def himport(self):
        ...
        localctx = GlacierParser.HimportContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                if la_ == 1:
                    ...
                    self._errHandler.sync(self)
                    _la = self._input.LA(1)
                    if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.AS) | (1 << GlacierParser.HIDING) | (1 << GlacierParser.QUALIFIED) | (1 << GlacierParser.EXPORT) | (1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CAPI) | (1 << GlacierParser.JSCALL) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0) or _la==GlacierParser.OpenRoundBracket or _la==GlacierParser.VARID:
                        self.state = 764
                        self.sig_vars()
    ...
    class CnameContext(ParserRuleContext):
        ...
        def con(self):
            return self.getTypedRuleContext(GlacierParser.ConContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_cname
    ...
    def cname(self):
        ...
        localctx = GlacierParser.CnameContext(self, self._ctx, self.state)
    ...
    class FixityContext(ParserRuleContext):
        ...
        def INFIX(self):
            return self.getToken(GlacierParser.INFIX, 0)

        def INFIXL(self):
            return self.getToken(GlacierParser.INFIXL, 0)

        def INFIXR(self):
            return self.getToken(GlacierParser.INFIXR, 0)

        def getRuleIndex(self):
            return GlacierParser.RULE_fixity
    ...
    def fixity(self):
        ...
        localctx = GlacierParser.FixityContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.state = 776
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.INFIX) | (1 << GlacierParser.INFIXL) | (1 << GlacierParser.INFIXR))) != 0)):
    ...
    class OpsContext(ParserRuleContext):
        ...
        def op(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.OpContext)
            else:
                return self.getTypedRuleContext(GlacierParser.OpContext,i)
    ...
    def ops(self):
        ...
        localctx = GlacierParser.OpsContext(self, self._ctx, self.state)
    ...
    class TopdeclsContext(ParserRuleContext):
        ...
        def topdecl(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.TopdeclContext)
            else:
                return self.getTypedRuleContext(GlacierParser.TopdeclContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_topdecls
    ...
    def topdecls(self):
        ...
        localctx = GlacierParser.TopdeclsContext(self, self._ctx, self.state)
    ...
    class TopdeclContext(ParserRuleContext):
        ...
        def cl_decl(self):
            return self.getTypedRuleContext(GlacierParser.Cl_declContext,0)


        def ty_decl(self):
            return self.getTypedRuleContext(GlacierParser.Ty_declContext,0)


        def standalone_kind_sig(self):
            return self.getTypedRuleContext(GlacierParser.Standalone_kind_sigContext,0)


        def inst_decl(self):
            return self.getTypedRuleContext(GlacierParser.Inst_declContext,0)


        def standalone_deriving(self):
            return self.getTypedRuleContext(GlacierParser.Standalone_derivingContext,0)


        def role_annot(self):
            return self.getTypedRuleContext(GlacierParser.Role_annotContext,0)


        def DEFAULT(self):
            return self.getToken(GlacierParser.DEFAULT, 0)
        ...
        def comma_types(self):
            return self.getTypedRuleContext(GlacierParser.Comma_typesContext,0)


        def FOREIGN(self):
            return self.getToken(GlacierParser.FOREIGN, 0)

        def fdecl(self):
            return self.getTypedRuleContext(GlacierParser.FdeclContext,0)
        ...
        def DEPRECATED(self):
            return self.getToken(GlacierParser.DEPRECATED, 0)

        def ClosePragmaBracket(self):
            return self.getToken(GlacierParser.ClosePragmaBracket, 0)

        def deprecations(self):
            return self.getTypedRuleContext(GlacierParser.DeprecationsContext,0)


        def WARNING(self):
            return self.getToken(GlacierParser.WARNING, 0)

        def warnings(self):
            return self.getTypedRuleContext(GlacierParser.WarningsContext,0)


        def RULES(self):
            return self.getToken(GlacierParser.RULES, 0)

        def rules(self):
            return self.getTypedRuleContext(GlacierParser.RulesContext,0)


        def annotation(self):
            return self.getTypedRuleContext(GlacierParser.AnnotationContext,0)


        def decl_no_th(self):
            return self.getTypedRuleContext(GlacierParser.Decl_no_thContext,0)


        def infixexp(self):
            return self.getTypedRuleContext(GlacierParser.InfixexpContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_topdecl
    ...
    def topdecl(self):
        ...
        localctx = GlacierParser.TopdeclContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.state = 804
                self.match(GlacierParser.DEFAULT)
                self.state = 805
                self.match(GlacierParser.OpenRoundBracket)
                self.state = 807
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.AS) | (1 << GlacierParser.HIDING) | (1 << GlacierParser.QUALIFIED) | (1 << GlacierParser.WILDCARD) | (1 << GlacierParser.FORALL) | (1 << GlacierParser.EXPORT) | (1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CAPI) | (1 << GlacierParser.JSCALL) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0) or ((((_la - 82)) & ~0x3f) == 0 and ((1 << (_la - 82)) & ((1 << (GlacierParser.Hash - 82)) | (1 << (GlacierParser.Less - 82)) | (1 << (GlacierParser.Greater - 82)) | (1 << (GlacierParser.Ampersand - 82)) | (1 << (GlacierParser.Pipe - 82)) | (1 << (GlacierParser.Bang - 82)) | (1 << (GlacierParser.Caret - 82)) | (1 << (GlacierParser.Plus - 82)) | (1 << (GlacierParser.Minus - 82)) | (1 << (GlacierParser.Asterisk - 82)) | (1 << (GlacierParser.Percent - 82)) | (1 << (GlacierParser.Divide - 82)) | (1 << (GlacierParser.Tilde - 82)) | (1 << (GlacierParser.Atsign - 82)) | (1 << (GlacierParser.Dollar - 82)) | (1 << (GlacierParser.Dot - 82)) | (1 << (GlacierParser.QuestionMark - 82)) | (1 << (GlacierParser.Colon - 82)) | (1 << (GlacierParser.Eq - 82)) | (1 << (GlacierParser.Quote - 82)) | (1 << (GlacierParser.ReverseSlash - 82)) | (1 << (GlacierParser.BackQuote - 82)) | (1 << (GlacierParser.OpenBoxParen - 82)) | (1 << (GlacierParser.OpenRoundBracket - 82)) | (1 << (GlacierParser.OpenSquareBracket - 82)) | (1 << (GlacierParser.STRING - 82)) | (1 << (GlacierParser.VARID - 82)) | (1 << (GlacierParser.CONID - 82)) | (1 << (GlacierParser.OpenPragmaBracket - 82)) | (1 << (GlacierParser.OCURLY - 82)) | (1 << (GlacierParser.DECIMAL - 82)) | (1 << (GlacierParser.OCTAL - 82)) | (1 << (GlacierParser.HEXADECIMAL - 82)))) != 0):
                    self.state = 806
                    self.comma_types()
                ...
                self.state = 810
                self.match(GlacierParser.FOREIGN)
                self.state = 811
                self.fdecl()
                pass
                ...
                self.match(GlacierParser.OpenPragmaBracket)
                self.state = 813
                self.match(GlacierParser.DEPRECATED)
                self.state = 815
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.AS) | (1 << GlacierParser.HIDING) | (1 << GlacierParser.QUALIFIED) | (1 << GlacierParser.EXPORT) | (1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CAPI) | (1 << GlacierParser.JSCALL) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0) or ((((_la - 118)) & ~0x3f) == 0 and ((1 << (_la - 118)) & ((1 << (GlacierParser.OpenBoxParen - 118)) | (1 << (GlacierParser.OpenRoundBracket - 118)) | (1 << (GlacierParser.OpenSquareBracket - 118)) | (1 << (GlacierParser.VARID - 118)) | (1 << (GlacierParser.CONID - 118)))) != 0):
                ...
                self.match(GlacierParser.OpenPragmaBracket)
                self.state = 819
                self.match(GlacierParser.WARNING)
                self.state = 821
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.AS) | (1 << GlacierParser.HIDING) | (1 << GlacierParser.QUALIFIED) | (1 << GlacierParser.EXPORT) | (1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CAPI) | (1 << GlacierParser.JSCALL) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0) or ((((_la - 118)) & ~0x3f) == 0 and ((1 << (_la - 118)) & ((1 << (GlacierParser.OpenBoxParen - 118)) | (1 << (GlacierParser.OpenRoundBracket - 118)) | (1 << (GlacierParser.OpenSquareBracket - 118)) | (1 << (GlacierParser.VARID - 118)) | (1 << (GlacierParser.CONID - 118)))) != 0):
                ...
                self.match(GlacierParser.OpenPragmaBracket)
                self.state = 825
                self.match(GlacierParser.RULES)
                self.state = 827
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if _la==GlacierParser.STRING:
                    self.state = 826
                    self.rules()
    ...
    class Cl_declContext(ParserRuleContext):
        ...
        def CLASS(self):
            return self.getToken(GlacierParser.CLASS, 0)

        def tycl_hdr(self):
            return self.getTypedRuleContext(GlacierParser.Tycl_hdrContext,0)


        def fds(self):
            return self.getTypedRuleContext(GlacierParser.FdsContext,0)


        def where_cls(self):
            return self.getTypedRuleContext(GlacierParser.Where_clsContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_cl_decl
    ...
    def cl_decl(self):
        ...
        localctx = GlacierParser.Cl_declContext(self, self._ctx, self.state)
        self.enterRule(localctx, 44, self.RULE_cl_decl)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 835
            self.match(GlacierParser.CLASS)
            self.state = 836
            self.tycl_hdr()
            self.state = 838
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if _la==GlacierParser.Pipe:
                self.state = 837
                self.fds()
    ...
    class Ty_declContext(ParserRuleContext):
        ...
        def TYPE(self):
            return self.getToken(GlacierParser.TYPE, 0)

        def type_hs(self):
            return self.getTypedRuleContext(GlacierParser.Type_hsContext,0)


        def Eq(self):
            return self.getToken(GlacierParser.Eq, 0)

        def ktypedoc(self):
            return self.getTypedRuleContext(GlacierParser.KtypedocContext,0)


        def FAMILY(self):
            return self.getToken(GlacierParser.FAMILY, 0)

        def opt_tyfam_kind_sig(self):
            return self.getTypedRuleContext(GlacierParser.Opt_tyfam_kind_sigContext,0)


        def opt_injective_info(self):
            return self.getTypedRuleContext(GlacierParser.Opt_injective_infoContext,0)


        def where_type_family(self):
            return self.getTypedRuleContext(GlacierParser.Where_type_familyContext,0)


        def DATA(self):
            return self.getToken(GlacierParser.DATA, 0)
        ...
        def constrs(self):
            return self.getTypedRuleContext(GlacierParser.ConstrsContext,0)


        def capi_ctype(self):
            return self.getTypedRuleContext(GlacierParser.Capi_ctypeContext,0)


        def derivings(self):
            return self.getTypedRuleContext(GlacierParser.DerivingsContext,0)


        def NEWTYPE(self):
            return self.getToken(GlacierParser.NEWTYPE, 0)

        def opt_kind_sig(self):
            return self.getTypedRuleContext(GlacierParser.Opt_kind_sigContext,0)


        def gadt_constrlist(self):
            return self.getTypedRuleContext(GlacierParser.Gadt_constrlistContext,0)


        def opt_datafam_kind_sig(self):
            return self.getTypedRuleContext(GlacierParser.Opt_datafam_kind_sigContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_ty_decl
    ...
    def ty_decl(self):
        ...
        localctx = GlacierParser.Ty_declContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                self.enterOuterAlt(localctx, 1)
                self.state = 843
                self.match(GlacierParser.TYPE)
                self.state = 844
                self.type_hs()
                self.state = 845
                self.match(GlacierParser.Eq)
                self.state = 846
                self.ktypedoc()
                pass
                ...
                self.match(GlacierParser.TYPE)
                self.state = 849
                self.match(GlacierParser.FAMILY)
                self.state = 850
                self.type_hs()
                self.state = 852
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if _la==GlacierParser.DoubleColon or _la==GlacierParser.Eq:
                    self.state = 851
                ...
                self.enterOuterAlt(localctx, 4)
                self.state = 869
                self.match(GlacierParser.NEWTYPE)
                self.state = 871
                self._errHandler.sync(self)
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if _la==GlacierParser.DoubleColon:
                    self.state = 883
                    self.opt_kind_sig()
    ...
    class Standalone_kind_sigContext(ParserRuleContext):
        ...
        def sks_vars(self):
            return self.getTypedRuleContext(GlacierParser.Sks_varsContext,0)


        def DoubleColon(self):
            return self.getToken(GlacierParser.DoubleColon, 0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_standalone_kind_sig
    ...
    def standalone_kind_sig(self):
        ...
        localctx = GlacierParser.Standalone_kind_sigContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.sks_vars()
            self.state = 916
            self.match(GlacierParser.DoubleColon)
            self.state = 917
            self.ktypedoc()
        except RecognitionException as re:
            localctx.exception = re
    ...
    class Sks_varsContext(ParserRuleContext):
        ...
        def oqtycon(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.OqtyconContext)
            else:
                return self.getTypedRuleContext(GlacierParser.OqtyconContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_sks_vars
    ...
    def sks_vars(self):
        ...
        localctx = GlacierParser.Sks_varsContext(self, self._ctx, self.state)
    ...
    class Inst_declContext(ParserRuleContext):
        ...
        def INSTANCE(self):
            return self.getToken(GlacierParser.INSTANCE, 0)

        def inst_type(self):
            return self.getTypedRuleContext(GlacierParser.Inst_typeContext,0)


        def overlap_pragma(self):
            return self.getTypedRuleContext(GlacierParser.Overlap_pragmaContext,0)


        def where_inst(self):
            return self.getTypedRuleContext(GlacierParser.Where_instContext,0)
        ...
        def ty_fam_inst_eqn(self):
            return self.getTypedRuleContext(GlacierParser.Ty_fam_inst_eqnContext,0)
        ...
        def tycl_hdr_inst(self):
            return self.getTypedRuleContext(GlacierParser.Tycl_hdr_instContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_inst_decl
    ...
    def inst_decl(self):
        ...
        localctx = GlacierParser.Inst_declContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                self.enterOuterAlt(localctx, 1)
                self.state = 927
                self.match(GlacierParser.INSTANCE)
                self.state = 929
                self._errHandler.sync(self)
    ...
    class Overlap_pragmaContext(ParserRuleContext):
        ...
        def OVERLAPPABLE(self):
            return self.getToken(GlacierParser.OVERLAPPABLE, 0)

        def ClosePragmaBracket(self):
            return self.getToken(GlacierParser.ClosePragmaBracket, 0)

        def OVERLAPPING(self):
            return self.getToken(GlacierParser.OVERLAPPING, 0)

        def OVERLAPS(self):
            return self.getToken(GlacierParser.OVERLAPS, 0)

        def INCOHERENT(self):
            return self.getToken(GlacierParser.INCOHERENT, 0)

        def getRuleIndex(self):
            return GlacierParser.RULE_overlap_pragma
    ...
    def overlap_pragma(self):
        ...
        localctx = GlacierParser.Overlap_pragmaContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.match(GlacierParser.OpenPragmaBracket)
                self.state = 989
                self.match(GlacierParser.OVERLAPPABLE)
                self.state = 990
                self.match(GlacierParser.ClosePragmaBracket)
                pass
                ...
                self.match(GlacierParser.OpenPragmaBracket)
                self.state = 992
                self.match(GlacierParser.OVERLAPPING)
                self.state = 993
                self.match(GlacierParser.ClosePragmaBracket)
                pass
                ...
                self.match(GlacierParser.OpenPragmaBracket)
                self.state = 995
                self.match(GlacierParser.OVERLAPS)
                self.state = 996
                self.match(GlacierParser.ClosePragmaBracket)
                pass
                ...
                self.match(GlacierParser.OpenPragmaBracket)
                self.state = 998
                self.match(GlacierParser.INCOHERENT)
                self.state = 999
                self.match(GlacierParser.ClosePragmaBracket)
                pass
    ...
    class Deriv_strategy_no_viaContext(ParserRuleContext):
        ...
        def STOCK(self):
            return self.getToken(GlacierParser.STOCK, 0)

        def ANYCLASS(self):
            return self.getToken(GlacierParser.ANYCLASS, 0)

        def NEWTYPE(self):
            return self.getToken(GlacierParser.NEWTYPE, 0)

        def getRuleIndex(self):
            return GlacierParser.RULE_deriv_strategy_no_via
    ...
    def deriv_strategy_no_via(self):
        ...
        localctx = GlacierParser.Deriv_strategy_no_viaContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.state = 1002
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.NEWTYPE) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS))) != 0)):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    class Deriv_strategy_viaContext(ParserRuleContext):
        ...
        def VIA(self):
            return self.getToken(GlacierParser.VIA, 0)

        def ktype(self):
            return self.getTypedRuleContext(GlacierParser.KtypeContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_deriv_strategy_via
    ...
    def deriv_strategy_via(self):
        ...
        localctx = GlacierParser.Deriv_strategy_viaContext(self, self._ctx, self.state)
        self.enterRule(localctx, 58, self.RULE_deriv_strategy_via)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 1004
            self.match(GlacierParser.VIA)
            self.state = 1005
            self.ktype()
        except RecognitionException as re:
            localctx.exception = re
    ...
    class Deriv_standalone_strategyContext(ParserRuleContext):
        ...
        def deriv_strategy_via(self):
            return self.getTypedRuleContext(GlacierParser.Deriv_strategy_viaContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_deriv_standalone_strategy
    ...
    def deriv_standalone_strategy(self):
        ...
        localctx = GlacierParser.Deriv_standalone_strategyContext(self, self._ctx, self.state)
        self.enterRule(localctx, 60, self.RULE_deriv_standalone_strategy)
        try:
            self.state = 1011
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [GlacierParser.STOCK]:
                self.enterOuterAlt(localctx, 1)
                self.state = 1007
                self.match(GlacierParser.STOCK)
                pass
            elif token in [GlacierParser.ANYCLASS]:
                self.enterOuterAlt(localctx, 2)
                self.state = 1008
                self.match(GlacierParser.ANYCLASS)
                pass
            elif token in [GlacierParser.NEWTYPE]:
                self.enterOuterAlt(localctx, 3)
                self.state = 1009
                self.match(GlacierParser.NEWTYPE)
                pass
            elif token in [GlacierParser.VIA]:
                self.enterOuterAlt(localctx, 4)
                self.state = 1010
    ...
    class Opt_injective_infoContext(ParserRuleContext):
        ...
        def Pipe(self):
            return self.getToken(GlacierParser.Pipe, 0)

        def injectivity_cond(self):
            return self.getTypedRuleContext(GlacierParser.Injectivity_condContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_opt_injective_info
    ...
    def opt_injective_info(self):
        ...
        localctx = GlacierParser.Opt_injective_infoContext(self, self._ctx, self.state)
        self.enterRule(localctx, 62, self.RULE_opt_injective_info)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 1013
            self.match(GlacierParser.Pipe)
            self.state = 1014
    ...
    class Injectivity_condContext(ParserRuleContext):
        ...
        def tyvarid(self):
            return self.getTypedRuleContext(GlacierParser.TyvaridContext,0)


        def Arrow(self):
            return self.getToken(GlacierParser.Arrow, 0)

        def inj_varids(self):
            return self.getTypedRuleContext(GlacierParser.Inj_varidsContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_injectivity_cond
    ...
    def injectivity_cond(self):
        ...
        localctx = GlacierParser.Injectivity_condContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.tyvarid()
            self.state = 1017
            self.match(GlacierParser.Arrow)
            self.state = 1018
            self.inj_varids()
        except RecognitionException as re:
            localctx.exception = re
    ...
    class Inj_varidsContext(ParserRuleContext):
        ...
        def tyvarid(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.TyvaridContext)
            else:
                return self.getTypedRuleContext(GlacierParser.TyvaridContext,i)


        def getRuleIndex(self):
            return GlacierParser.RULE_inj_varids
    ...
    def inj_varids(self):
        ...
        localctx = GlacierParser.Inj_varidsContext(self, self._ctx, self.state)
        ...
        try:
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.AS) | (1 << GlacierParser.HIDING) | (1 << GlacierParser.QUALIFIED) | (1 << GlacierParser.EXPORT) | (1 << GlacierParser.SAFE) | (1 << GlacierParser.INTERRUPTIBLE) | (1 << GlacierParser.UNSAFE) | (1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CAPI) | (1 << GlacierParser.JSCALL) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0) or _la==GlacierParser.VARID):
                    break
    ...
    class Where_type_familyContext(ParserRuleContext):
        ...
        def ty_fam_inst_eqn_list(self):
            return self.getTypedRuleContext(GlacierParser.Ty_fam_inst_eqn_listContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_where_type_family
    ...
    def where_type_family(self):
        ...
        localctx = GlacierParser.Where_type_familyContext(self, self._ctx, self.state)
    ...
    class Ty_fam_inst_eqn_listContext(ParserRuleContext):
        ...
        def ty_fam_inst_eqns(self):
            return self.getTypedRuleContext(GlacierParser.Ty_fam_inst_eqnsContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_ty_fam_inst_eqn_list
    ...
    def ty_fam_inst_eqn_list(self):
        ...
        localctx = GlacierParser.Ty_fam_inst_eqn_listContext(self, self._ctx, self.state)
    ...
    class Ty_fam_inst_eqnsContext(ParserRuleContext):
        ...
        def ty_fam_inst_eqn(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.Ty_fam_inst_eqnContext)
            else:
                return self.getTypedRuleContext(GlacierParser.Ty_fam_inst_eqnContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_ty_fam_inst_eqns
    ...
    def ty_fam_inst_eqns(self):
        ...
        localctx = GlacierParser.Ty_fam_inst_eqnsContext(self, self._ctx, self.state)
        ...
        try:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    while True:
                        ...
                        self._errHandler.sync(self)
                        _la = self._input.LA(1)
                        if not (_la==GlacierParser.Semi or _la==GlacierParser.SEMI):
                            break
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while _la==GlacierParser.Semi or _la==GlacierParser.SEMI:
                self.state = 1056
                self.semi()
                self.state = 1061
                self._errHandler.sync(self)
    ...
    class Ty_fam_inst_eqnContext(ParserRuleContext):
        ...
        def FORALL(self):
            return self.getToken(GlacierParser.FORALL, 0)

        def Dot(self):
            return self.getToken(GlacierParser.Dot, 0)
        ...
        def tv_bndrs(self):
            return self.getTypedRuleContext(GlacierParser.Tv_bndrsContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_ty_fam_inst_eqn
    ...
    def ty_fam_inst_eqn(self):
        ...
        localctx = GlacierParser.Ty_fam_inst_eqnContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [GlacierParser.FORALL]:
                self.enterOuterAlt(localctx, 1)
                self.state = 1062
                self.match(GlacierParser.FORALL)
                self.state = 1064
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.AS) | (1 << GlacierParser.HIDING) | (1 << GlacierParser.QUALIFIED) | (1 << GlacierParser.EXPORT) | (1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CAPI) | (1 << GlacierParser.JSCALL) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0) or ((((_la - 120)) & ~0x3f) == 0 and ((1 << (_la - 120)) & ((1 << (GlacierParser.OpenRoundBracket - 120)) | (1 << (GlacierParser.VARID - 120)) | (1 << (GlacierParser.OCURLY - 120)))) != 0):
                    self.state = 1063
                    self.tv_bndrs()


                self.state = 1066
                self.match(GlacierParser.Dot)
                self.state = 1067
                self.type_hs()
                self.state = 1068
                self.match(GlacierParser.Eq)
                ...
                self.ktype()
                pass
            elif token in [GlacierParser.AS, GlacierParser.HIDING, GlacierParser.QUALIFIED, GlacierParser.WILDCARD, GlacierParser.EXPORT, GlacierParser.STDCALL, GlacierParser.CCALL, GlacierParser.CAPI, GlacierParser.JSCALL, GlacierParser.STOCK, GlacierParser.ANYCLASS, GlacierParser.VIA, GlacierParser.Hash, GlacierParser.Less, GlacierParser.Greater, GlacierParser.Ampersand, GlacierParser.Pipe, GlacierParser.Bang, GlacierParser.Caret, GlacierParser.Plus, GlacierParser.Minus, GlacierParser.Asterisk, GlacierParser.Percent, GlacierParser.Divide, GlacierParser.Tilde, GlacierParser.Atsign, GlacierParser.Dollar, GlacierParser.Dot, GlacierParser.QuestionMark, GlacierParser.Colon, GlacierParser.Eq, GlacierParser.Quote, GlacierParser.ReverseSlash, GlacierParser.BackQuote, GlacierParser.OpenBoxParen, GlacierParser.OpenRoundBracket, GlacierParser.OpenSquareBracket, GlacierParser.STRING, GlacierParser.VARID, GlacierParser.CONID, GlacierParser.OpenPragmaBracket, GlacierParser.OCURLY, GlacierParser.DECIMAL, GlacierParser.OCTAL, GlacierParser.HEXADECIMAL]:
                self.enterOuterAlt(localctx, 2)
                self.state = 1071
                self.type_hs()
                self.state = 1072
    ...
    class At_decl_clsContext(ParserRuleContext):
        ...
        def opt_at_kind_inj_sig(self):
            return self.getTypedRuleContext(GlacierParser.Opt_at_kind_inj_sigContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_at_decl_cls
    ...
    def at_decl_cls(self):
        ...
        localctx = GlacierParser.At_decl_clsContext(self, self._ctx, self.state)
    ...
    class At_decl_instContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_at_decl_inst
    ...
    def at_decl_inst(self):
        ...
        localctx = GlacierParser.At_decl_instContext(self, self._ctx, self.state)
    ...
    class Opt_kind_sigContext(ParserRuleContext):
        ...
        def kind(self):
            return self.getTypedRuleContext(GlacierParser.KindContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_opt_kind_sig
    ...
    def opt_kind_sig(self):
        ...
        localctx = GlacierParser.Opt_kind_sigContext(self, self._ctx, self.state)
    ...
    class Opt_datafam_kind_sigContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_opt_datafam_kind_sig
    ...
    def opt_datafam_kind_sig(self):
        ...
        localctx = GlacierParser.Opt_datafam_kind_sigContext(self, self._ctx, self.state)
    ...
    class Opt_tyfam_kind_sigContext(ParserRuleContext):
        ...
        def tv_bndr(self):
            return self.getTypedRuleContext(GlacierParser.Tv_bndrContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_opt_tyfam_kind_sig
    ...
    def opt_tyfam_kind_sig(self):
        ...
        localctx = GlacierParser.Opt_tyfam_kind_sigContext(self, self._ctx, self.state)
        self.enterRule(localctx, 84, self.RULE_opt_tyfam_kind_sig)
        try:
            self.state = 1175
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [GlacierParser.DoubleColon]:
                self.enterOuterAlt(localctx, 1)
                self.state = 1171
                self.match(GlacierParser.DoubleColon)
                self.state = 1172
                self.kind()
                pass
            elif token in [GlacierParser.Eq]:
                self.enterOuterAlt(localctx, 2)
                self.state = 1173
                self.match(GlacierParser.Eq)
                self.state = 1174
    ...
    class Opt_at_kind_inj_sigContext(ParserRuleContext):
        ...
        def tv_bndr_no_braces(self):
            return self.getTypedRuleContext(GlacierParser.Tv_bndr_no_bracesContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_opt_at_kind_inj_sig
    ...
    def opt_at_kind_inj_sig(self):
        ...
        localctx = GlacierParser.Opt_at_kind_inj_sigContext(self, self._ctx, self.state)
    ...
    class Tycl_hdrContext(ParserRuleContext):
        ...
        def tycl_context(self):
            return self.getTypedRuleContext(GlacierParser.Tycl_contextContext,0)


        def DoubleArrow(self):
            return self.getToken(GlacierParser.DoubleArrow, 0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_tycl_hdr
    ...
    def tycl_hdr(self):
        ...
        localctx = GlacierParser.Tycl_hdrContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.tycl_context()
                self.state = 1187
                self.match(GlacierParser.DoubleArrow)
                self.state = 1188
                self.type_hs()
                pass
    ...
    class Tycl_hdr_instContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_tycl_hdr_inst
    ...
    def tycl_hdr_inst(self):
        ...
        localctx = GlacierParser.Tycl_hdr_instContext(self, self._ctx, self.state)
    ...
    class Capi_ctypeContext(ParserRuleContext):
        ...
        def CTYPE(self):
            return self.getToken(GlacierParser.CTYPE, 0)

        def STRING(self, i:int=None):
            if i is None:
                return self.getTokens(GlacierParser.STRING)
            else:
                return self.getToken(GlacierParser.STRING, i)

        def ClosePragmaBracket(self):
            return self.getToken(GlacierParser.ClosePragmaBracket, 0)

        def getRuleIndex(self):
            return GlacierParser.RULE_capi_ctype
    ...
    def capi_ctype(self):
        ...
        localctx = GlacierParser.Capi_ctypeContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.match(GlacierParser.OpenPragmaBracket)
                self.state = 1216
                self.match(GlacierParser.CTYPE)
                self.state = 1217
                self.match(GlacierParser.STRING)
                self.state = 1218
                self.match(GlacierParser.STRING)
                self.state = 1219
                self.match(GlacierParser.ClosePragmaBracket)
    ...
    class Standalone_derivingContext(ParserRuleContext):
        ...
        def DERIVING(self):
            return self.getToken(GlacierParser.DERIVING, 0)
        ...
        def deriv_standalone_strategy(self):
            return self.getTypedRuleContext(GlacierParser.Deriv_standalone_strategyContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_standalone_deriving
    ...
    def standalone_deriving(self):
        ...
        localctx = GlacierParser.Standalone_derivingContext(self, self._ctx, self.state)
        self.enterRule(localctx, 94, self.RULE_standalone_deriving)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 1226
            self.match(GlacierParser.DERIVING)
            self.state = 1228
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.NEWTYPE) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0):
                self.state = 1227
    ...
    class Role_annotContext(ParserRuleContext):
        ...
        def ROLE(self):
            return self.getToken(GlacierParser.ROLE, 0)

        def oqtycon(self):
            return self.getTypedRuleContext(GlacierParser.OqtyconContext,0)


        def roles(self):
            return self.getTypedRuleContext(GlacierParser.RolesContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_role_annot
    ...
    def role_annot(self):
        ...
        localctx = GlacierParser.Role_annotContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(GlacierParser.TYPE)
            self.state = 1237
            self.match(GlacierParser.ROLE)
            self.state = 1238
            self.oqtycon()
            self.state = 1240
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.AS) | (1 << GlacierParser.HIDING) | (1 << GlacierParser.QUALIFIED) | (1 << GlacierParser.WILDCARD) | (1 << GlacierParser.EXPORT) | (1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CAPI) | (1 << GlacierParser.JSCALL) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0) or _la==GlacierParser.VARID:
                self.state = 1239
                self.roles()
    ...
    class RolesContext(ParserRuleContext):
        ...
        def role(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.RoleContext)
            else:
                return self.getTypedRuleContext(GlacierParser.RoleContext,i)


        def getRuleIndex(self):
            return GlacierParser.RULE_roles
    ...
    def roles(self):
        ...
        localctx = GlacierParser.RolesContext(self, self._ctx, self.state)
        ...
        try:
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.AS) | (1 << GlacierParser.HIDING) | (1 << GlacierParser.QUALIFIED) | (1 << GlacierParser.WILDCARD) | (1 << GlacierParser.EXPORT) | (1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CAPI) | (1 << GlacierParser.JSCALL) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0) or _la==GlacierParser.VARID):
                    break
    ...
    class RoleContext(ParserRuleContext):
        ...
        def varid(self):
            return self.getTypedRuleContext(GlacierParser.VaridContext,0)


        def WILDCARD(self):
            return self.getToken(GlacierParser.WILDCARD, 0)

        def getRuleIndex(self):
            return GlacierParser.RULE_role
    ...
    def role(self):
        ...
        localctx = GlacierParser.RoleContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if token in [GlacierParser.AS, GlacierParser.HIDING, GlacierParser.QUALIFIED, GlacierParser.EXPORT, GlacierParser.STDCALL, GlacierParser.CCALL, GlacierParser.CAPI, GlacierParser.JSCALL, GlacierParser.STOCK, GlacierParser.ANYCLASS, GlacierParser.VIA, GlacierParser.VARID]:
                ...
                self.varid()
                pass
            elif token in [GlacierParser.WILDCARD]:
                self.enterOuterAlt(localctx, 2)
                self.state = 1248
                self.match(GlacierParser.WILDCARD)
                pass
            else:
                raise NoViableAltException(self)
    ...
    class Pattern_synonym_declContext(ParserRuleContext):
        ...
        def PATTERN(self):
            return self.getToken(GlacierParser.PATTERN, 0)

        def pattern_synonym_lhs(self):
            return self.getTypedRuleContext(GlacierParser.Pattern_synonym_lhsContext,0)
        ...
        def pat(self):
            return self.getTypedRuleContext(GlacierParser.PatContext,0)


        def Revarrow(self):
            return self.getToken(GlacierParser.Revarrow, 0)

        def where_decls(self):
            return self.getTypedRuleContext(GlacierParser.Where_declsContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_pattern_synonym_decl
    ...
    def pattern_synonym_decl(self):
        ...
        localctx = GlacierParser.Pattern_synonym_declContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                self.enterOuterAlt(localctx, 1)
                self.state = 1251
                self.match(GlacierParser.PATTERN)
                self.state = 1252
                ...
                self.pattern_synonym_lhs()
                self.state = 1258
                self.match(GlacierParser.Revarrow)
                self.state = 1259
                self.pat()
                self.state = 1261
                self._errHandler.sync(self)
    ...
    class Pattern_synonym_lhsContext(ParserRuleContext):
        ...
        def vars_hs(self):
            return self.getTypedRuleContext(GlacierParser.Vars_hsContext,0)
        ...
        def conop(self):
            return self.getTypedRuleContext(GlacierParser.ConopContext,0)
        ...
        def cvars(self):
            return self.getTypedRuleContext(GlacierParser.CvarsContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_pattern_synonym_lhs
    ...
    def pattern_synonym_lhs(self):
        ...
        localctx = GlacierParser.Pattern_synonym_lhsContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.AS) | (1 << GlacierParser.HIDING) | (1 << GlacierParser.QUALIFIED) | (1 << GlacierParser.EXPORT) | (1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CAPI) | (1 << GlacierParser.JSCALL) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0) or _la==GlacierParser.VARID:
                    self.state = 1266
                    self.vars_hs()
    ...
    class Vars_hsContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_vars_hs

        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterVars_hs" ):
                listener.enterVars_hs(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitVars_hs" ):
                listener.exitVars_hs(self)
    ...
    def vars_hs(self):
        ...
        localctx = GlacierParser.Vars_hsContext(self, self._ctx, self.state)
        self.enterRule(localctx, 106, self.RULE_vars_hs)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 1281 
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.AS) | (1 << GlacierParser.HIDING) | (1 << GlacierParser.QUALIFIED) | (1 << GlacierParser.EXPORT) | (1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CAPI) | (1 << GlacierParser.JSCALL) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0) or _la==GlacierParser.VARID):
                    break
    ...
    class CvarsContext(ParserRuleContext):
        ...
        def var(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.VarContext)
            else:
                return self.getTypedRuleContext(GlacierParser.VarContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_cvars
    ...
    def cvars(self):
        ...
        localctx = GlacierParser.CvarsContext(self, self._ctx, self.state)
    ...
    class Where_declsContext(ParserRuleContext):
        ...
        def decls(self):
            return self.getTypedRuleContext(GlacierParser.DeclsContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_where_decls
    ...
    def where_decls(self):
        ...
        localctx = GlacierParser.Where_declsContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.AS) | (1 << GlacierParser.CASE) | (1 << GlacierParser.DO) | (1 << GlacierParser.HIDING) | (1 << GlacierParser.IF) | (1 << GlacierParser.INFIX) | (1 << GlacierParser.INFIXL) | (1 << GlacierParser.INFIXR) | (1 << GlacierParser.LET) | (1 << GlacierParser.QUALIFIED) | (1 << GlacierParser.WILDCARD) | (1 << GlacierParser.EXPORT) | (1 << GlacierParser.MDO) | (1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CAPI) | (1 << GlacierParser.JSCALL) | (1 << GlacierParser.PATTERN) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0) or ((((_la - 73)) & ~0x3f) == 0 and ((1 << (_la - 73)) & ((1 << (GlacierParser.LCASE - 73)) | (1 << (GlacierParser.Bang - 73)) | (1 << (GlacierParser.Minus - 73)) | (1 << (GlacierParser.Tilde - 73)) | (1 << (GlacierParser.DDollar - 73)) | (1 << (GlacierParser.Dollar - 73)) | (1 << (GlacierParser.Semi - 73)) | (1 << (GlacierParser.Quote - 73)) | (1 << (GlacierParser.DoubleQuote - 73)) | (1 << (GlacierParser.ReverseSlash - 73)) | (1 << (GlacierParser.AopenParen - 73)) | (1 << (GlacierParser.TopenTexpQuote - 73)) | (1 << (GlacierParser.TopenExpQuote - 73)) | (1 << (GlacierParser.TopenPatQuote - 73)) | (1 << (GlacierParser.TopenTypQoute - 73)) | (1 << (GlacierParser.TopenDecQoute - 73)) | (1 << (GlacierParser.OpenBoxParen - 73)) | (1 << (GlacierParser.OpenRoundBracket - 73)) | (1 << (GlacierParser.OpenSquareBracket - 73)) | (1 << (GlacierParser.CHAR - 73)) | (1 << (GlacierParser.STRING - 73)) | (1 << (GlacierParser.VARID - 73)) | (1 << (GlacierParser.CONID - 73)) | (1 << (GlacierParser.OpenPragmaBracket - 73)) | (1 << (GlacierParser.SEMI - 73)))) != 0) or ((((_la - 137)) & ~0x3f) == 0 and ((1 << (_la - 137)) & ((1 << (GlacierParser.DECIMAL - 137)) | (1 << (GlacierParser.OCTAL - 137)) | (1 << (GlacierParser.HEXADECIMAL - 137)) | (1 << (GlacierParser.FLOAT - 137)))) != 0):
                self.state = 1295
                self.decls()
    ...
    class Pattern_synonym_sigContext(ParserRuleContext):
        ...
        def con_list(self):
            return self.getTypedRuleContext(GlacierParser.Con_listContext,0)
        ...
        def sigtypedoc(self):
            return self.getTypedRuleContext(GlacierParser.SigtypedocContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_pattern_synonym_sig
    ...
    def pattern_synonym_sig(self):
        ...
        localctx = GlacierParser.Pattern_synonym_sigContext(self, self._ctx, self.state)
    ...
    class Decl_clsContext(ParserRuleContext):
        ...
        def at_decl_cls(self):
            return self.getTypedRuleContext(GlacierParser.At_decl_clsContext,0)


        def decl(self):
            return self.getTypedRuleContext(GlacierParser.DeclContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_decl_cls
    ...
    def decl_cls(self):
        ...
        localctx = GlacierParser.Decl_clsContext(self, self._ctx, self.state)
        self.enterRule(localctx, 114, self.RULE_decl_cls)
        try:
            self.state = 1312
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [GlacierParser.DATA, GlacierParser.TYPE]:
                self.enterOuterAlt(localctx, 1)
                self.state = 1305
                self.at_decl_cls()
                pass
            elif token in [GlacierParser.AS, GlacierParser.CASE, GlacierParser.DO, GlacierParser.HIDING, GlacierParser.IF, GlacierParser.INFIX, GlacierParser.INFIXL, GlacierParser.INFIXR, GlacierParser.LET, GlacierParser.QUALIFIED, GlacierParser.WILDCARD, GlacierParser.EXPORT, GlacierParser.MDO, GlacierParser.STDCALL, GlacierParser.CCALL, GlacierParser.CAPI, GlacierParser.JSCALL, GlacierParser.PATTERN, GlacierParser.STOCK, GlacierParser.ANYCLASS, GlacierParser.VIA, GlacierParser.LCASE, GlacierParser.Bang, GlacierParser.Minus, GlacierParser.Tilde, GlacierParser.DDollar, GlacierParser.Dollar, GlacierParser.Semi, GlacierParser.Quote, GlacierParser.DoubleQuote, GlacierParser.ReverseSlash, GlacierParser.AopenParen, GlacierParser.TopenTexpQuote, GlacierParser.TopenExpQuote, GlacierParser.TopenPatQuote, GlacierParser.TopenTypQoute, GlacierParser.TopenDecQoute, GlacierParser.OpenBoxParen, GlacierParser.OpenRoundBracket, GlacierParser.OpenSquareBracket, GlacierParser.CHAR, GlacierParser.STRING, GlacierParser.VARID, GlacierParser.CONID, GlacierParser.OpenPragmaBracket, GlacierParser.SEMI, GlacierParser.DECIMAL, GlacierParser.OCTAL, GlacierParser.HEXADECIMAL, GlacierParser.FLOAT]:
                self.enterOuterAlt(localctx, 2)
                self.state = 1306
                self.decl()
                pass
            elif token in [GlacierParser.DEFAULT]:
                self.enterOuterAlt(localctx, 3)
                self.state = 1307
                self.match(GlacierParser.DEFAULT)
                self.state = 1308
    ...
    class Decls_clsContext(ParserRuleContext):
        ...
        def decl_cls(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.Decl_clsContext)
            else:
                return self.getTypedRuleContext(GlacierParser.Decl_clsContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_decls_cls
    ...
    def decls_cls(self):
        ...
        localctx = GlacierParser.Decls_clsContext(self, self._ctx, self.state)
    ...
    class Decllist_clsContext(ParserRuleContext):
        ...
        def decls_cls(self):
            return self.getTypedRuleContext(GlacierParser.Decls_clsContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_decllist_cls
    ...
    def decllist_cls(self):
        ...
        localctx = GlacierParser.Decllist_clsContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.AS) | (1 << GlacierParser.CASE) | (1 << GlacierParser.DATA) | (1 << GlacierParser.DEFAULT) | (1 << GlacierParser.DO) | (1 << GlacierParser.HIDING) | (1 << GlacierParser.IF) | (1 << GlacierParser.INFIX) | (1 << GlacierParser.INFIXL) | (1 << GlacierParser.INFIXR) | (1 << GlacierParser.LET) | (1 << GlacierParser.QUALIFIED) | (1 << GlacierParser.TYPE) | (1 << GlacierParser.WILDCARD) | (1 << GlacierParser.EXPORT) | (1 << GlacierParser.MDO) | (1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CAPI) | (1 << GlacierParser.JSCALL) | (1 << GlacierParser.PATTERN) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0) or ((((_la - 73)) & ~0x3f) == 0 and ((1 << (_la - 73)) & ((1 << (GlacierParser.LCASE - 73)) | (1 << (GlacierParser.Bang - 73)) | (1 << (GlacierParser.Minus - 73)) | (1 << (GlacierParser.Tilde - 73)) | (1 << (GlacierParser.DDollar - 73)) | (1 << (GlacierParser.Dollar - 73)) | (1 << (GlacierParser.Semi - 73)) | (1 << (GlacierParser.Quote - 73)) | (1 << (GlacierParser.DoubleQuote - 73)) | (1 << (GlacierParser.ReverseSlash - 73)) | (1 << (GlacierParser.AopenParen - 73)) | (1 << (GlacierParser.TopenTexpQuote - 73)) | (1 << (GlacierParser.TopenExpQuote - 73)) | (1 << (GlacierParser.TopenPatQuote - 73)) | (1 << (GlacierParser.TopenTypQoute - 73)) | (1 << (GlacierParser.TopenDecQoute - 73)) | (1 << (GlacierParser.OpenBoxParen - 73)) | (1 << (GlacierParser.OpenRoundBracket - 73)) | (1 << (GlacierParser.OpenSquareBracket - 73)) | (1 << (GlacierParser.CHAR - 73)) | (1 << (GlacierParser.STRING - 73)) | (1 << (GlacierParser.VARID - 73)) | (1 << (GlacierParser.CONID - 73)) | (1 << (GlacierParser.OpenPragmaBracket - 73)) | (1 << (GlacierParser.SEMI - 73)))) != 0) or ((((_la - 137)) & ~0x3f) == 0 and ((1 << (_la - 137)) & ((1 << (GlacierParser.DECIMAL - 137)) | (1 << (GlacierParser.OCTAL - 137)) | (1 << (GlacierParser.HEXADECIMAL - 137)) | (1 << (GlacierParser.FLOAT - 137)))) != 0):
                self.state = 1334
                self.decls_cls()
    ...
    class Where_clsContext(ParserRuleContext):
        ...
        def decllist_cls(self):
            return self.getTypedRuleContext(GlacierParser.Decllist_clsContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_where_cls
    ...
    def where_cls(self):
        ...
        localctx = GlacierParser.Where_clsContext(self, self._ctx, self.state)
    ...
    class Decl_instContext(ParserRuleContext):
        ...
        def at_decl_inst(self):
            return self.getTypedRuleContext(GlacierParser.At_decl_instContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_decl_inst
    ...
    def decl_inst(self):
        ...
        localctx = GlacierParser.Decl_instContext(self, self._ctx, self.state)
        self.enterRule(localctx, 122, self.RULE_decl_inst)
        try:
            self.state = 1344
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [GlacierParser.DATA, GlacierParser.NEWTYPE, GlacierParser.TYPE]:
                self.enterOuterAlt(localctx, 1)
                self.state = 1342
                self.at_decl_inst()
                pass
    ...
    class Decls_instContext(ParserRuleContext):
        ...
        def decl_inst(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.Decl_instContext)
            else:
                return self.getTypedRuleContext(GlacierParser.Decl_instContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_decls_inst
    ...
    def decls_inst(self):
        ...
        localctx = GlacierParser.Decls_instContext(self, self._ctx, self.state)
    ...
    class Decllist_instContext(ParserRuleContext):
        ...
        def decls_inst(self):
            return self.getTypedRuleContext(GlacierParser.Decls_instContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_decllist_inst
    ...
    def decllist_inst(self):
        ...
        localctx = GlacierParser.Decllist_instContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.AS) | (1 << GlacierParser.CASE) | (1 << GlacierParser.DATA) | (1 << GlacierParser.DO) | (1 << GlacierParser.HIDING) | (1 << GlacierParser.IF) | (1 << GlacierParser.INFIX) | (1 << GlacierParser.INFIXL) | (1 << GlacierParser.INFIXR) | (1 << GlacierParser.LET) | (1 << GlacierParser.NEWTYPE) | (1 << GlacierParser.QUALIFIED) | (1 << GlacierParser.TYPE) | (1 << GlacierParser.WILDCARD) | (1 << GlacierParser.EXPORT) | (1 << GlacierParser.MDO) | (1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CAPI) | (1 << GlacierParser.JSCALL) | (1 << GlacierParser.PATTERN) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0) or ((((_la - 73)) & ~0x3f) == 0 and ((1 << (_la - 73)) & ((1 << (GlacierParser.LCASE - 73)) | (1 << (GlacierParser.Bang - 73)) | (1 << (GlacierParser.Minus - 73)) | (1 << (GlacierParser.Tilde - 73)) | (1 << (GlacierParser.DDollar - 73)) | (1 << (GlacierParser.Dollar - 73)) | (1 << (GlacierParser.Semi - 73)) | (1 << (GlacierParser.Quote - 73)) | (1 << (GlacierParser.DoubleQuote - 73)) | (1 << (GlacierParser.ReverseSlash - 73)) | (1 << (GlacierParser.AopenParen - 73)) | (1 << (GlacierParser.TopenTexpQuote - 73)) | (1 << (GlacierParser.TopenExpQuote - 73)) | (1 << (GlacierParser.TopenPatQuote - 73)) | (1 << (GlacierParser.TopenTypQoute - 73)) | (1 << (GlacierParser.TopenDecQoute - 73)) | (1 << (GlacierParser.OpenBoxParen - 73)) | (1 << (GlacierParser.OpenRoundBracket - 73)) | (1 << (GlacierParser.OpenSquareBracket - 73)) | (1 << (GlacierParser.CHAR - 73)) | (1 << (GlacierParser.STRING - 73)) | (1 << (GlacierParser.VARID - 73)) | (1 << (GlacierParser.CONID - 73)) | (1 << (GlacierParser.OpenPragmaBracket - 73)) | (1 << (GlacierParser.SEMI - 73)))) != 0) or ((((_la - 137)) & ~0x3f) == 0 and ((1 << (_la - 137)) & ((1 << (GlacierParser.DECIMAL - 137)) | (1 << (GlacierParser.OCTAL - 137)) | (1 << (GlacierParser.HEXADECIMAL - 137)) | (1 << (GlacierParser.FLOAT - 137)))) != 0):
                self.state = 1366
                self.decls_inst()
    ...
    class Where_instContext(ParserRuleContext):
        ...
        def decllist_inst(self):
            return self.getTypedRuleContext(GlacierParser.Decllist_instContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_where_inst
    ...
    def where_inst(self):
        ...
        localctx = GlacierParser.Where_instContext(self, self._ctx, self.state)
    ...
    class DeclsContext(ParserRuleContext):
        ...
        def decl(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.DeclContext)
            else:
                return self.getTypedRuleContext(GlacierParser.DeclContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_decls
    ...
    def decls(self):
        ...
        localctx = GlacierParser.DeclsContext(self, self._ctx, self.state)
    ...
    class DecllistContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_decllist
    ...
    def decllist(self):
        ...
        localctx = GlacierParser.DecllistContext(self, self._ctx, self.state)
    ...
    class BindsContext(ParserRuleContext):
        ...
        def decllist(self):
            return self.getTypedRuleContext(GlacierParser.DecllistContext,0)
        ...
        def dbinds(self):
            return self.getTypedRuleContext(GlacierParser.DbindsContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_binds
    ...
    def binds(self):
        ...
        localctx = GlacierParser.BindsContext(self, self._ctx, self.state)
    ...
    class WherebindsContext(ParserRuleContext):
        ...
        def binds(self):
            return self.getTypedRuleContext(GlacierParser.BindsContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_wherebinds
    ...
    def wherebinds(self):
        ...
        localctx = GlacierParser.WherebindsContext(self, self._ctx, self.state)
    ...
    class RulesContext(ParserRuleContext):
        ...
        def pragma_rule(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.Pragma_ruleContext)
            else:
                return self.getTypedRuleContext(GlacierParser.Pragma_ruleContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_rules
    ...
    def rules(self):
        ...
        localctx = GlacierParser.RulesContext(self, self._ctx, self.state)
    ...
    class Pragma_ruleContext(ParserRuleContext):
        ...
        def pstring(self):
            return self.getTypedRuleContext(GlacierParser.PstringContext,0)
        ...
        def exp(self):
            return self.getTypedRuleContext(GlacierParser.ExpContext,0)


        def rule_activation(self):
            return self.getTypedRuleContext(GlacierParser.Rule_activationContext,0)


        def rule_foralls(self):
            return self.getTypedRuleContext(GlacierParser.Rule_forallsContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_pragma_rule
    ...
    def pragma_rule(self):
        ...
        localctx = GlacierParser.Pragma_ruleContext(self, self._ctx, self.state)
    ...
    class Rule_activation_markerContext(ParserRuleContext):
        ...
        def Tilde(self):
            return self.getToken(GlacierParser.Tilde, 0)

        def varsym(self):
            return self.getTypedRuleContext(GlacierParser.VarsymContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_rule_activation_marker
    ...
    def rule_activation_marker(self):
        ...
        localctx = GlacierParser.Rule_activation_markerContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                self.enterOuterAlt(localctx, 1)
                self.state = 1434
                self.match(GlacierParser.Tilde)
                pass
    ...
    class Rule_activationContext(ParserRuleContext):
        ...
        def OpenSquareBracket(self):
            return self.getToken(GlacierParser.OpenSquareBracket, 0)

        def integer(self):
            return self.getTypedRuleContext(GlacierParser.IntegerContext,0)


        def CloseSquareBracket(self):
            return self.getToken(GlacierParser.CloseSquareBracket, 0)

        def rule_activation_marker(self):
            return self.getTypedRuleContext(GlacierParser.Rule_activation_markerContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_rule_activation
    ...
    def rule_activation(self):
        ...
        localctx = GlacierParser.Rule_activationContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                self.enterOuterAlt(localctx, 1)
                self.state = 1438
                self.match(GlacierParser.OpenSquareBracket)
                self.state = 1439
                self.integer()
                self.state = 1440
                self.match(GlacierParser.CloseSquareBracket)
                pass
    ...
    class Rule_forallsContext(ParserRuleContext):
        ...
        def FORALL(self, i:int=None):
            if i is None:
                return self.getTokens(GlacierParser.FORALL)
            else:
                return self.getToken(GlacierParser.FORALL, i)

        def Dot(self, i:int=None):
            if i is None:
                return self.getTokens(GlacierParser.Dot)
            else:
                return self.getToken(GlacierParser.Dot, i)

        def rule_vars(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.Rule_varsContext)
            else:
                return self.getTypedRuleContext(GlacierParser.Rule_varsContext,i)


        def getRuleIndex(self):
            return GlacierParser.RULE_rule_foralls
    ...
    def rule_foralls(self):
        ...
        localctx = GlacierParser.Rule_forallsContext(self, self._ctx, self.state)
    ...
    class Rule_varsContext(ParserRuleContext):
        ...
        def rule_var(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.Rule_varContext)
            else:
                return self.getTypedRuleContext(GlacierParser.Rule_varContext,i)


        def getRuleIndex(self):
            return GlacierParser.RULE_rule_vars
    ...
    def rule_vars(self):
        ...
        localctx = GlacierParser.Rule_varsContext(self, self._ctx, self.state)
        ...
        try:
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.AS) | (1 << GlacierParser.HIDING) | (1 << GlacierParser.QUALIFIED) | (1 << GlacierParser.EXPORT) | (1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CAPI) | (1 << GlacierParser.JSCALL) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0) or _la==GlacierParser.OpenRoundBracket or _la==GlacierParser.VARID):
                    break
    ...
    class Rule_varContext(ParserRuleContext):
        ...
        def ctype(self):
            return self.getTypedRuleContext(GlacierParser.CtypeContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_rule_var
    ...
    def rule_var(self):
        ...
        localctx = GlacierParser.Rule_varContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if token in [GlacierParser.AS, GlacierParser.HIDING, GlacierParser.QUALIFIED, GlacierParser.EXPORT, GlacierParser.STDCALL, GlacierParser.CCALL, GlacierParser.CAPI, GlacierParser.JSCALL, GlacierParser.STOCK, GlacierParser.ANYCLASS, GlacierParser.VIA, GlacierParser.VARID]:
                ...
                self.varid()
                pass
            elif token in [GlacierParser.OpenRoundBracket]:
                self.enterOuterAlt(localctx, 2)
                self.state = 1471
                self.match(GlacierParser.OpenRoundBracket)
                self.state = 1472
    ...
    class WarningsContext(ParserRuleContext):
        ...
        def pragma_warning(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.Pragma_warningContext)
            else:
                return self.getTypedRuleContext(GlacierParser.Pragma_warningContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_warnings
    ...
    def warnings(self):
        ...
        localctx = GlacierParser.WarningsContext(self, self._ctx, self.state)
    ...
    class Pragma_warningContext(ParserRuleContext):
        ...
        def namelist(self):
            return self.getTypedRuleContext(GlacierParser.NamelistContext,0)


        def strings(self):
            return self.getTypedRuleContext(GlacierParser.StringsContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_pragma_warning
    ...
    def pragma_warning(self):
        ...
        localctx = GlacierParser.Pragma_warningContext(self, self._ctx, self.state)
    ...
    class DeprecationsContext(ParserRuleContext):
        ...
        def pragma_deprecation(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.Pragma_deprecationContext)
            else:
                return self.getTypedRuleContext(GlacierParser.Pragma_deprecationContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_deprecations
    ...
    def deprecations(self):
        ...
        localctx = GlacierParser.DeprecationsContext(self, self._ctx, self.state)
    ...
    class Pragma_deprecationContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_pragma_deprecation
    ...
    def pragma_deprecation(self):
        ...
        localctx = GlacierParser.Pragma_deprecationContext(self, self._ctx, self.state)
    ...
    class StringsContext(ParserRuleContext):
        ...
        def stringlist(self):
            return self.getTypedRuleContext(GlacierParser.StringlistContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_strings
    ...
    def strings(self):
        ...
        localctx = GlacierParser.StringsContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [GlacierParser.STRING]:
                self.enterOuterAlt(localctx, 1)
                self.state = 1509
                self.pstring()
                pass
            elif token in [GlacierParser.OpenSquareBracket]:
                self.enterOuterAlt(localctx, 2)
                self.state = 1510
                self.match(GlacierParser.OpenSquareBracket)
                self.state = 1512
    ...
    class StringlistContext(ParserRuleContext):
        ...
        def pstring(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.PstringContext)
            else:
                return self.getTypedRuleContext(GlacierParser.PstringContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_stringlist
    ...
    def stringlist(self):
        ...
        localctx = GlacierParser.StringlistContext(self, self._ctx, self.state)
    ...
    class AnnotationContext(ParserRuleContext):
        ...
        def ANN(self):
            return self.getToken(GlacierParser.ANN, 0)

        def name_var(self):
            return self.getTypedRuleContext(GlacierParser.Name_varContext,0)


        def aexp(self):
            return self.getTypedRuleContext(GlacierParser.AexpContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_annotation
    ...
    def annotation(self):
        ...
        localctx = GlacierParser.AnnotationContext(self, self._ctx, self.state)
    ...
    class FdeclContext(ParserRuleContext):
        ...
        def callconv(self):
            return self.getTypedRuleContext(GlacierParser.CallconvContext,0)


        def fspec(self):
            return self.getTypedRuleContext(GlacierParser.FspecContext,0)


        def safety(self):
            return self.getTypedRuleContext(GlacierParser.SafetyContext,0)


        def EXPORT(self):
            return self.getToken(GlacierParser.EXPORT, 0)

        def getRuleIndex(self):
            return GlacierParser.RULE_fdecl
    ...
    def fdecl(self):
        ...
        localctx = GlacierParser.FdeclContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if token in [GlacierParser.IMPORT]:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.SAFE) | (1 << GlacierParser.INTERRUPTIBLE) | (1 << GlacierParser.UNSAFE))) != 0):
                    self.state = 1547
                    self.safety()
                ...
                self.fspec()
                pass
            elif token in [GlacierParser.EXPORT]:
                self.enterOuterAlt(localctx, 2)
                self.state = 1552
                self.match(GlacierParser.EXPORT)
                self.state = 1553
                self.callconv()
                self.state = 1554
                self.fspec()
    ...
    class CallconvContext(ParserRuleContext):
        ...
        def CCALL(self):
            return self.getToken(GlacierParser.CCALL, 0)

        def STDCALL(self):
            return self.getToken(GlacierParser.STDCALL, 0)

        def CPPCALL(self):
            return self.getToken(GlacierParser.CPPCALL, 0)

        def JSCALL(self):
            return self.getToken(GlacierParser.JSCALL, 0)

        def getRuleIndex(self):
            return GlacierParser.RULE_callconv
    ...
    def callconv(self):
        ...
        localctx = GlacierParser.CallconvContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.state = 1558
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CPPCALL) | (1 << GlacierParser.JSCALL))) != 0)):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    class SafetyContext(ParserRuleContext):
        ...
        def UNSAFE(self):
            return self.getToken(GlacierParser.UNSAFE, 0)

        def SAFE(self):
            return self.getToken(GlacierParser.SAFE, 0)

        def INTERRUPTIBLE(self):
            return self.getToken(GlacierParser.INTERRUPTIBLE, 0)

        def getRuleIndex(self):
            return GlacierParser.RULE_safety
    ...
    def safety(self):
        ...
        localctx = GlacierParser.SafetyContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.state = 1560
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.SAFE) | (1 << GlacierParser.INTERRUPTIBLE) | (1 << GlacierParser.UNSAFE))) != 0)):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    class FspecContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_fspec
    ...
    def fspec(self):
        ...
        localctx = GlacierParser.FspecContext(self, self._ctx, self.state)
    ...
    class Opt_sigContext(ParserRuleContext):
        ...
        def sigtype(self):
            return self.getTypedRuleContext(GlacierParser.SigtypeContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_opt_sig
    ...
    def opt_sig(self):
        ...
        localctx = GlacierParser.Opt_sigContext(self, self._ctx, self.state)
    ...
    class Opt_tyconsigContext(ParserRuleContext):
        ...
        def gtycon(self):
            return self.getTypedRuleContext(GlacierParser.GtyconContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_opt_tyconsig
    ...
    def opt_tyconsig(self):
        ...
        localctx = GlacierParser.Opt_tyconsigContext(self, self._ctx, self.state)
    ...
    class SigtypeContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_sigtype
    ...
    def sigtype(self):
        ...
        localctx = GlacierParser.SigtypeContext(self, self._ctx, self.state)
    ...
    class SigtypedocContext(ParserRuleContext):
        ...
        def ctypedoc(self):
            return self.getTypedRuleContext(GlacierParser.CtypedocContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_sigtypedoc
    ...
    def sigtypedoc(self):
        ...
        localctx = GlacierParser.SigtypedocContext(self, self._ctx, self.state)
    ...
    class Sig_varsContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_sig_vars
    ...
    def sig_vars(self):
        ...
        localctx = GlacierParser.Sig_varsContext(self, self._ctx, self.state)
    ...
    class Sigtypes1Context(ParserRuleContext):
        ...
        def sigtype(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.SigtypeContext)
            else:
                return self.getTypedRuleContext(GlacierParser.SigtypeContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_sigtypes1
    ...
    def sigtypes1(self):
        ...
        localctx = GlacierParser.Sigtypes1Context(self, self._ctx, self.state)
    ...
    class UnpackednessContext(ParserRuleContext):
        ...
        def UNPACK(self):
            return self.getToken(GlacierParser.UNPACK, 0)

        def ClosePragmaBracket(self):
            return self.getToken(GlacierParser.ClosePragmaBracket, 0)

        def NOUNPACK(self):
            return self.getToken(GlacierParser.NOUNPACK, 0)

        def getRuleIndex(self):
            return GlacierParser.RULE_unpackedness
    ...
    def unpackedness(self):
        ...
        localctx = GlacierParser.UnpackednessContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.match(GlacierParser.OpenPragmaBracket)
                self.state = 1596
                self.match(GlacierParser.UNPACK)
                self.state = 1597
                self.match(GlacierParser.ClosePragmaBracket)
                pass
                ...
                self.match(GlacierParser.OpenPragmaBracket)
                self.state = 1599
                self.match(GlacierParser.NOUNPACK)
                self.state = 1600
                self.match(GlacierParser.ClosePragmaBracket)
                pass
    ...
    class Forall_vis_flagContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_forall_vis_flag
    ...
    def forall_vis_flag(self):
        ...
        localctx = GlacierParser.Forall_vis_flagContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.state = 1603
            _la = self._input.LA(1)
            if not(_la==GlacierParser.Arrow or _la==GlacierParser.Dot):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    class KtypeContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_ktype
    ...
    def ktype(self):
        ...
        localctx = GlacierParser.KtypeContext(self, self._ctx, self.state)
    ...
    class KtypedocContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_ktypedoc
    ...
    def ktypedoc(self):
        ...
        localctx = GlacierParser.KtypedocContext(self, self._ctx, self.state)
    ...
    class CtypeContext(ParserRuleContext):
        ...
        def forall_vis_flag(self):
            return self.getTypedRuleContext(GlacierParser.Forall_vis_flagContext,0)
        ...
        def btype(self):
            return self.getTypedRuleContext(GlacierParser.BtypeContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_ctype
    ...
    def ctype(self):
        ...
        localctx = GlacierParser.CtypeContext(self, self._ctx, self.state)
    ...
    class CtypedocContext(ParserRuleContext):
        ...
        def typedoc(self):
            return self.getTypedRuleContext(GlacierParser.TypedocContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_ctypedoc
    ...
    def ctypedoc(self):
        ...
        localctx = GlacierParser.CtypedocContext(self, self._ctx, self.state)
    ...
    class Tycl_contextContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_tycl_context
    ...
    def tycl_context(self):
        ...
        localctx = GlacierParser.Tycl_contextContext(self, self._ctx, self.state)
    ...
    class Constr_contextContext(ParserRuleContext):
        ...
        def constr_btype(self):
            return self.getTypedRuleContext(GlacierParser.Constr_btypeContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_constr_context
    ...
    def constr_context(self):
        ...
        localctx = GlacierParser.Constr_contextContext(self, self._ctx, self.state)
    ...
    class Type_hsContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_type_hs

        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterType_hs" ):
                listener.enterType_hs(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitType_hs" ):
                listener.exitType_hs(self)
    ...
    def type_hs(self):
        ...
        localctx = GlacierParser.Type_hsContext(self, self._ctx, self.state)
        self.enterRule(localctx, 202, self.RULE_type_hs)
        try:
            self.state = 1664
            self._errHandler.sync(self)
    ...
    class TypedocContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_typedoc
    ...
    def typedoc(self):
        ...
        localctx = GlacierParser.TypedocContext(self, self._ctx, self.state)
    ...
    class Constr_btypeContext(ParserRuleContext):
        ...
        def constr_tyapps(self):
            return self.getTypedRuleContext(GlacierParser.Constr_tyappsContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_constr_btype
    ...
    def constr_btype(self):
        ...
        localctx = GlacierParser.Constr_btypeContext(self, self._ctx, self.state)
    ...
    class Constr_tyappsContext(ParserRuleContext):
        ...
        def constr_tyapp(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.Constr_tyappContext)
            else:
                return self.getTypedRuleContext(GlacierParser.Constr_tyappContext,i)


        def getRuleIndex(self):
            return GlacierParser.RULE_constr_tyapps
    ...
    def constr_tyapps(self):
        ...
        localctx = GlacierParser.Constr_tyappsContext(self, self._ctx, self.state)
    ...
    class Constr_tyappContext(ParserRuleContext):
        ...
        def tyapp(self):
            return self.getTypedRuleContext(GlacierParser.TyappContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_constr_tyapp
    ...
    def constr_tyapp(self):
        ...
        localctx = GlacierParser.Constr_tyappContext(self, self._ctx, self.state)
    ...
    class BtypeContext(ParserRuleContext):
        ...
        def tyapps(self):
            return self.getTypedRuleContext(GlacierParser.TyappsContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_btype
    ...
    def btype(self):
        ...
        localctx = GlacierParser.BtypeContext(self, self._ctx, self.state)
    ...
    class TyappsContext(ParserRuleContext):
        ...
        def tyapp(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.TyappContext)
            else:
                return self.getTypedRuleContext(GlacierParser.TyappContext,i)


        def getRuleIndex(self):
            return GlacierParser.RULE_tyapps
    ...
    def tyapps(self):
        ...
        localctx = GlacierParser.TyappsContext(self, self._ctx, self.state)
    ...
    class TyappContext(ParserRuleContext):
        ...
        def atype(self):
            return self.getTypedRuleContext(GlacierParser.AtypeContext,0)


        def Atsign(self):
            return self.getToken(GlacierParser.Atsign, 0)

        def qtyconop(self):
            return self.getTypedRuleContext(GlacierParser.QtyconopContext,0)


        def tyvarop(self):
            return self.getTypedRuleContext(GlacierParser.TyvaropContext,0)


        def Quote(self):
            return self.getToken(GlacierParser.Quote, 0)

        def qconop(self):
            return self.getTypedRuleContext(GlacierParser.QconopContext,0)


        def varop(self):
            return self.getTypedRuleContext(GlacierParser.VaropContext,0)


        def unpackedness(self):
            return self.getTypedRuleContext(GlacierParser.UnpackednessContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_tyapp
    ...
    def tyapp(self):
        ...
        localctx = GlacierParser.TyappContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.enterOuterAlt(localctx, 2)
                self.state = 1690
                self.match(GlacierParser.Atsign)
                self.state = 1691
                self.atype()
                pass
                ...
                self.enterOuterAlt(localctx, 5)
                self.state = 1694
                self.match(GlacierParser.Quote)
                self.state = 1695
                self.qconop()
                pass
    ...
    class AtypeContext(ParserRuleContext):
        ...
        def ntgtycon(self):
            return self.getTypedRuleContext(GlacierParser.NtgtyconContext,0)


        def tyvar(self):
            return self.getTypedRuleContext(GlacierParser.TyvarContext,0)


        def Asterisk(self):
            return self.getToken(GlacierParser.Asterisk, 0)
        ...
        def Bang(self):
            return self.getToken(GlacierParser.Bang, 0)
        ...
        def fielddecls(self):
            return self.getTypedRuleContext(GlacierParser.FielddeclsContext,0)
        ...
        def Comma(self):
            return self.getToken(GlacierParser.Comma, 0)
        ...
        def OpenBoxParen(self):
            return self.getToken(GlacierParser.OpenBoxParen, 0)

        def CloseBoxParen(self):
            return self.getToken(GlacierParser.CloseBoxParen, 0)

        def bar_types2(self):
            return self.getTypedRuleContext(GlacierParser.Bar_types2Context,0)
        ...
        def quasiquote(self):
            return self.getTypedRuleContext(GlacierParser.QuasiquoteContext,0)


        def splice_untyped(self):
            return self.getTypedRuleContext(GlacierParser.Splice_untypedContext,0)
        ...
        def qcon_nowiredlist(self):
            return self.getTypedRuleContext(GlacierParser.Qcon_nowiredlistContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_atype
    ...
    def atype(self):
        ...
        localctx = GlacierParser.AtypeContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.enterOuterAlt(localctx, 3)
                self.state = 1703
                self.match(GlacierParser.Asterisk)
                pass
                ...
                self.enterOuterAlt(localctx, 9)
                self.state = 1721
                self.match(GlacierParser.OpenBoxParen)
                self.state = 1722
                self.match(GlacierParser.CloseBoxParen)
                pass
    ...
    class Inst_typeContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_inst_type
    ...
    def inst_type(self):
        ...
        localctx = GlacierParser.Inst_typeContext(self, self._ctx, self.state)
    ...
    class Deriv_typesContext(ParserRuleContext):
        ...
        def ktypedoc(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.KtypedocContext)
            else:
                return self.getTypedRuleContext(GlacierParser.KtypedocContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_deriv_types
    ...
    def deriv_types(self):
        ...
        localctx = GlacierParser.Deriv_typesContext(self, self._ctx, self.state)
    ...
    class Comma_typesContext(ParserRuleContext):
        ...
        def ktype(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.KtypeContext)
            else:
                return self.getTypedRuleContext(GlacierParser.KtypeContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_comma_types
    ...
    def comma_types(self):
        ...
        localctx = GlacierParser.Comma_typesContext(self, self._ctx, self.state)
    ...
    class Bar_types2Context(ParserRuleContext):
        ...
        def Pipe(self, i:int=None):
            if i is None:
                return self.getTokens(GlacierParser.Pipe)
            else:
                return self.getToken(GlacierParser.Pipe, i)

        def getRuleIndex(self):
            return GlacierParser.RULE_bar_types2
    ...
    def bar_types2(self):
        ...
        localctx = GlacierParser.Bar_types2Context(self, self._ctx, self.state)
    ...
    class Tv_bndrsContext(ParserRuleContext):
        ...
        def tv_bndr(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.Tv_bndrContext)
            else:
                return self.getTypedRuleContext(GlacierParser.Tv_bndrContext,i)


        def getRuleIndex(self):
            return GlacierParser.RULE_tv_bndrs
    ...
    def tv_bndrs(self):
        ...
        localctx = GlacierParser.Tv_bndrsContext(self, self._ctx, self.state)
        ...
        try:
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.AS) | (1 << GlacierParser.HIDING) | (1 << GlacierParser.QUALIFIED) | (1 << GlacierParser.EXPORT) | (1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CAPI) | (1 << GlacierParser.JSCALL) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0) or ((((_la - 120)) & ~0x3f) == 0 and ((1 << (_la - 120)) & ((1 << (GlacierParser.OpenRoundBracket - 120)) | (1 << (GlacierParser.VARID - 120)) | (1 << (GlacierParser.OCURLY - 120)))) != 0)):
                    break
    ...
    class Tv_bndrContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_tv_bndr
    ...
    def tv_bndr(self):
        ...
        localctx = GlacierParser.Tv_bndrContext(self, self._ctx, self.state)
    ...
    class Tv_bndr_no_bracesContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_tv_bndr_no_braces
    ...
    def tv_bndr_no_braces(self):
        ...
        localctx = GlacierParser.Tv_bndr_no_bracesContext(self, self._ctx, self.state)
    ...
    class FdsContext(ParserRuleContext):
        ...
        def fds1(self):
            return self.getTypedRuleContext(GlacierParser.Fds1Context,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_fds
    ...
    def fds(self):
        ...
        localctx = GlacierParser.FdsContext(self, self._ctx, self.state)
    ...
    class Fds1Context(ParserRuleContext):
        ...
        def fd(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.FdContext)
            else:
                return self.getTypedRuleContext(GlacierParser.FdContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_fds1
    ...
    def fds1(self):
        ...
        localctx = GlacierParser.Fds1Context(self, self._ctx, self.state)
    ...
    class FdContext(ParserRuleContext):
        ...
        def varids0(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.Varids0Context)
            else:
                return self.getTypedRuleContext(GlacierParser.Varids0Context,i)


        def getRuleIndex(self):
            return GlacierParser.RULE_fd
    ...
    def fd(self):
        ...
        localctx = GlacierParser.FdContext(self, self._ctx, self.state)
    ...
    class Varids0Context(ParserRuleContext):
        ...
        def tyvar(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.TyvarContext)
            else:
                return self.getTypedRuleContext(GlacierParser.TyvarContext,i)


        def getRuleIndex(self):
            return GlacierParser.RULE_varids0
    ...
    def varids0(self):
        ...
        localctx = GlacierParser.Varids0Context(self, self._ctx, self.state)
    ...
    class KindContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_kind
    ...
    def kind(self):
        ...
        localctx = GlacierParser.KindContext(self, self._ctx, self.state)
    ...
    class Gadt_constrlistContext(ParserRuleContext):
        ...
        def gadt_constrs(self):
            return self.getTypedRuleContext(GlacierParser.Gadt_constrsContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_gadt_constrlist
    ...
    def gadt_constrlist(self):
        ...
        localctx = GlacierParser.Gadt_constrlistContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if ((((_la - 118)) & ~0x3f) == 0 and ((1 << (_la - 118)) & ((1 << (GlacierParser.OpenBoxParen - 118)) | (1 << (GlacierParser.OpenRoundBracket - 118)) | (1 << (GlacierParser.OpenSquareBracket - 118)) | (1 << (GlacierParser.CONID - 118)))) != 0):
                self.state = 1851
                self.gadt_constrs()
    ...
    class Gadt_constrsContext(ParserRuleContext):
        ...
        def gadt_constr_with_doc(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.Gadt_constr_with_docContext)
            else:
                return self.getTypedRuleContext(GlacierParser.Gadt_constr_with_docContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_gadt_constrs
    ...
    def gadt_constrs(self):
        ...
        localctx = GlacierParser.Gadt_constrsContext(self, self._ctx, self.state)
    ...
    class Gadt_constr_with_docContext(ParserRuleContext):
        ...
        def gadt_constr(self):
            return self.getTypedRuleContext(GlacierParser.Gadt_constrContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_gadt_constr_with_doc
    ...
    def gadt_constr_with_doc(self):
        ...
        localctx = GlacierParser.Gadt_constr_with_docContext(self, self._ctx, self.state)
    ...
    class Gadt_constrContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_gadt_constr
    ...
    def gadt_constr(self):
        ...
        localctx = GlacierParser.Gadt_constrContext(self, self._ctx, self.state)
    ...
    class ConstrsContext(ParserRuleContext):
        ...
        def constrs1(self):
            return self.getTypedRuleContext(GlacierParser.Constrs1Context,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_constrs
    ...
    def constrs(self):
        ...
        localctx = GlacierParser.ConstrsContext(self, self._ctx, self.state)
    ...
    class Constrs1Context(ParserRuleContext):
        ...
        def constr(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.ConstrContext)
            else:
                return self.getTypedRuleContext(GlacierParser.ConstrContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_constrs1
    ...
    def constrs1(self):
        ...
        localctx = GlacierParser.Constrs1Context(self, self._ctx, self.state)
    ...
    class ConstrContext(ParserRuleContext):
        ...
        def constr_stuff(self):
            return self.getTypedRuleContext(GlacierParser.Constr_stuffContext,0)


        def forall(self):
            return self.getTypedRuleContext(GlacierParser.ForallContext,0)


        def constr_context(self):
            return self.getTypedRuleContext(GlacierParser.Constr_contextContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_constr
    ...
    def constr(self):
        ...
        localctx = GlacierParser.ConstrContext(self, self._ctx, self.state)
    ...
    class ForallContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_forall
    ...
    def forall(self):
        ...
        localctx = GlacierParser.ForallContext(self, self._ctx, self.state)
    ...
    class Constr_stuffContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_constr_stuff
    ...
    def constr_stuff(self):
        ...
        localctx = GlacierParser.Constr_stuffContext(self, self._ctx, self.state)
    ...
    class FielddeclsContext(ParserRuleContext):
        ...
        def fielddecl(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.FielddeclContext)
            else:
                return self.getTypedRuleContext(GlacierParser.FielddeclContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_fielddecls
    ...
    def fielddecls(self):
        ...
        localctx = GlacierParser.FielddeclsContext(self, self._ctx, self.state)
    ...
    class FielddeclContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_fielddecl
    ...
    def fielddecl(self):
        ...
        localctx = GlacierParser.FielddeclContext(self, self._ctx, self.state)
    ...
    class DerivingsContext(ParserRuleContext):
        ...
        def deriving(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.DerivingContext)
            else:
                return self.getTypedRuleContext(GlacierParser.DerivingContext,i)


        def getRuleIndex(self):
            return GlacierParser.RULE_derivings
    ...
    def derivings(self):
        ...
        localctx = GlacierParser.DerivingsContext(self, self._ctx, self.state)
        ...
        try:
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not (_la==GlacierParser.DERIVING):
                    break
    ...
    class DerivingContext(ParserRuleContext):
        ...
        def deriv_clause_types(self):
            return self.getTypedRuleContext(GlacierParser.Deriv_clause_typesContext,0)


        def deriv_strategy_no_via(self):
            return self.getTypedRuleContext(GlacierParser.Deriv_strategy_no_viaContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_deriving
    ...
    def deriving(self):
        ...
        localctx = GlacierParser.DerivingContext(self, self._ctx, self.state)
    ...
    class Deriv_clause_typesContext(ParserRuleContext):
        ...
        def deriv_types(self):
            return self.getTypedRuleContext(GlacierParser.Deriv_typesContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_deriv_clause_types
    ...
    def deriv_clause_types(self):
        ...
        localctx = GlacierParser.Deriv_clause_typesContext(self, self._ctx, self.state)
    ...
    class Decl_no_thContext(ParserRuleContext):
        ...
        def sigdecl(self):
            return self.getTypedRuleContext(GlacierParser.SigdeclContext,0)
        ...
        def rhs(self):
            return self.getTypedRuleContext(GlacierParser.RhsContext,0)


        def opt_sig(self):
            return self.getTypedRuleContext(GlacierParser.Opt_sigContext,0)


        def pattern_synonym_decl(self):
            return self.getTypedRuleContext(GlacierParser.Pattern_synonym_declContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_decl_no_th
    ...
    def decl_no_th(self):
        ...
        localctx = GlacierParser.Decl_no_thContext(self, self._ctx, self.state)
    ...
    class DeclContext(ParserRuleContext):
        ...
        def splice_exp(self):
            return self.getTypedRuleContext(GlacierParser.Splice_expContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_decl
    ...
    def decl(self):
        ...
        localctx = GlacierParser.DeclContext(self, self._ctx, self.state)
    ...
    class RhsContext(ParserRuleContext):
        ...
        def wherebinds(self):
            return self.getTypedRuleContext(GlacierParser.WherebindsContext,0)


        def gdrhs(self):
            return self.getTypedRuleContext(GlacierParser.GdrhsContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_rhs
    ...
    def rhs(self):
        ...
        localctx = GlacierParser.RhsContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if token in [GlacierParser.Eq]:
                ...
                pass
            elif token in [GlacierParser.Pipe]:
                self.enterOuterAlt(localctx, 2)
                self.state = 1973
                self.gdrhs()
                self.state = 1975
    ...
    class GdrhsContext(ParserRuleContext):
        ...
        def gdrh(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.GdrhContext)
            else:
                return self.getTypedRuleContext(GlacierParser.GdrhContext,i)


        def getRuleIndex(self):
            return GlacierParser.RULE_gdrhs
    ...
    def gdrhs(self):
        ...
        localctx = GlacierParser.GdrhsContext(self, self._ctx, self.state)
    ...
    class GdrhContext(ParserRuleContext):
        ...
        def guards(self):
            return self.getTypedRuleContext(GlacierParser.GuardsContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_gdrh
    ...
    def gdrh(self):
        ...
        localctx = GlacierParser.GdrhContext(self, self._ctx, self.state)
    ...
    class SigdeclContext(ParserRuleContext):
        ...
        def fixity(self):
            return self.getTypedRuleContext(GlacierParser.FixityContext,0)


        def ops(self):
            return self.getTypedRuleContext(GlacierParser.OpsContext,0)
        ...
        def pattern_synonym_sig(self):
            return self.getTypedRuleContext(GlacierParser.Pattern_synonym_sigContext,0)
        ...
        def COMPLETE(self):
            return self.getToken(GlacierParser.COMPLETE, 0)
        ...
        def ClosePragmaBracket(self, i:int=None):
            if i is None:
                return self.getTokens(GlacierParser.ClosePragmaBracket)
            else:
                return self.getToken(GlacierParser.ClosePragmaBracket, i)

        def opt_tyconsig(self):
            return self.getTypedRuleContext(GlacierParser.Opt_tyconsigContext,0)


        def INLINE(self):
            return self.getToken(GlacierParser.INLINE, 0)

        def qvar(self):
            return self.getTypedRuleContext(GlacierParser.QvarContext,0)


        def activation(self):
            return self.getTypedRuleContext(GlacierParser.ActivationContext,0)


        def SCC(self):
            return self.getToken(GlacierParser.SCC, 0)
        ...
        def SPECIALISE(self):
            return self.getToken(GlacierParser.SPECIALISE, 0)

        def sigtypes1(self):
            return self.getTypedRuleContext(GlacierParser.Sigtypes1Context,0)


        def SPECINLINE(self):
            return self.getToken(GlacierParser.SPECINLINE, 0)
        ...
        def MINIMAL(self):
            return self.getToken(GlacierParser.MINIMAL, 0)

        def name_boolformula_opt(self):
            return self.getTypedRuleContext(GlacierParser.Name_boolformula_optContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_sigdecl
    ...
    def sigdecl(self):
        ...
        localctx = GlacierParser.SigdeclContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if ((((_la - 137)) & ~0x3f) == 0 and ((1 << (_la - 137)) & ((1 << (GlacierParser.DECIMAL - 137)) | (1 << (GlacierParser.OCTAL - 137)) | (1 << (GlacierParser.HEXADECIMAL - 137)))) != 0):
                    self.state = 2000
                    self.integer()
                ...
                self.match(GlacierParser.OpenPragmaBracket)
                self.state = 2007
                self.match(GlacierParser.COMPLETE)
                self.state = 2008
                self.con_list()
                self.state = 2010
                self._errHandler.sync(self)
                ...
                self.match(GlacierParser.OpenPragmaBracket)
                self.state = 2015
                self.match(GlacierParser.INLINE)
                self.state = 2017
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if _la==GlacierParser.OpenSquareBracket:
                    self.state = 2016
                    self.activation()
                ...
                self.match(GlacierParser.OpenPragmaBracket)
                self.state = 2031
                self.match(GlacierParser.SPECIALISE)
                self.state = 2033
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if _la==GlacierParser.OpenSquareBracket:
                ...
                self.match(GlacierParser.OpenPragmaBracket)
                self.state = 2041
                self.match(GlacierParser.SPECINLINE)
                self.state = 2043
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if _la==GlacierParser.OpenSquareBracket:
                ...
                self.match(GlacierParser.OpenPragmaBracket)
                self.state = 2057
                self.match(GlacierParser.MINIMAL)
                self.state = 2058
                self.match(GlacierParser.ClosePragmaBracket)
                self.state = 2060
                self._errHandler.sync(self)
    ...
    class ActivationContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_activation
    ...
    def activation(self):
        ...
        localctx = GlacierParser.ActivationContext(self, self._ctx, self.state)
    ...
    class Th_quasiquoteContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_th_quasiquote
    ...
    def th_quasiquote(self):
        ...
        localctx = GlacierParser.Th_quasiquoteContext(self, self._ctx, self.state)
    ...
    class Th_qquasiquoteContext(ParserRuleContext):
        ...
        def qvarid(self):
            return self.getTypedRuleContext(GlacierParser.QvaridContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_th_qquasiquote
    ...
    def th_qquasiquote(self):
        ...
        localctx = GlacierParser.Th_qquasiquoteContext(self, self._ctx, self.state)
    ...
    class QuasiquoteContext(ParserRuleContext):
        ...
        def th_quasiquote(self):
            return self.getTypedRuleContext(GlacierParser.Th_quasiquoteContext,0)


        def th_qquasiquote(self):
            return self.getTypedRuleContext(GlacierParser.Th_qquasiquoteContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_quasiquote
    ...
    def quasiquote(self):
        ...
        localctx = GlacierParser.QuasiquoteContext(self, self._ctx, self.state)
    ...
    class ExpContext(ParserRuleContext):
        ...
        def LarrowTail(self):
            return self.getToken(GlacierParser.LarrowTail, 0)
        ...
        def RarrowTail(self):
            return self.getToken(GlacierParser.RarrowTail, 0)

        def LLarrowTail(self):
            return self.getToken(GlacierParser.LLarrowTail, 0)

        def RRarrowTail(self):
            return self.getToken(GlacierParser.RRarrowTail, 0)

        def getRuleIndex(self):
            return GlacierParser.RULE_exp
    ...
    def exp(self):
        ...
        localctx = GlacierParser.ExpContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.infixexp()
                self.state = 2098
                self.match(GlacierParser.LarrowTail)
                self.state = 2099
                self.exp()
                pass
                ...
                self.infixexp()
                self.state = 2102
                self.match(GlacierParser.RarrowTail)
                self.state = 2103
                self.exp()
                pass
                ...
                self.infixexp()
                self.state = 2106
                self.match(GlacierParser.LLarrowTail)
                self.state = 2107
                self.exp()
                pass
                ...
                self.infixexp()
                self.state = 2110
                self.match(GlacierParser.RRarrowTail)
                self.state = 2111
                self.exp()
                pass
    ...
    class InfixexpContext(ParserRuleContext):
        ...
        def exp10(self):
            return self.getTypedRuleContext(GlacierParser.Exp10Context,0)


        def qop(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.QopContext)
            else:
                return self.getTypedRuleContext(GlacierParser.QopContext,i)


        def exp10p(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.Exp10pContext)
            else:
                return self.getTypedRuleContext(GlacierParser.Exp10pContext,i)


        def getRuleIndex(self):
            return GlacierParser.RULE_infixexp
    ...
    def infixexp(self):
        ...
        localctx = GlacierParser.InfixexpContext(self, self._ctx, self.state)
    ...
    class Exp10pContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_exp10p
    ...
    def exp10p(self):
        ...
        localctx = GlacierParser.Exp10pContext(self, self._ctx, self.state)
    ...
    class Exp10Context(ParserRuleContext):
        ...
        def fexp(self):
            return self.getTypedRuleContext(GlacierParser.FexpContext,0)


        def Minus(self):
            return self.getToken(GlacierParser.Minus, 0)

        def getRuleIndex(self):
            return GlacierParser.RULE_exp10
    ...
    def exp10(self):
        ...
        localctx = GlacierParser.Exp10Context(self, self._ctx, self.state)
    ...
    class FexpContext(ParserRuleContext):
        ...
        def aexp(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.AexpContext)
            else:
                return self.getTypedRuleContext(GlacierParser.AexpContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_fexp
    ...
    def fexp(self):
        ...
        localctx = GlacierParser.FexpContext(self, self._ctx, self.state)
    ...
    class AexpContext(ParserRuleContext):
        ...
        def ReverseSlash(self):
            return self.getToken(GlacierParser.ReverseSlash, 0)

        def apats(self):
            return self.getTypedRuleContext(GlacierParser.ApatsContext,0)
        ...
        def exp(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.ExpContext)
            else:
                return self.getTypedRuleContext(GlacierParser.ExpContext,i)


        def LET(self):
            return self.getToken(GlacierParser.LET, 0)
        ...
        def IN(self):
            return self.getToken(GlacierParser.IN, 0)

        def LCASE(self):
            return self.getToken(GlacierParser.LCASE, 0)

        def alts(self):
            return self.getTypedRuleContext(GlacierParser.AltsContext,0)


        def IF(self):
            return self.getToken(GlacierParser.IF, 0)

        def THEN(self):
            return self.getToken(GlacierParser.THEN, 0)

        def ELSE(self):
            return self.getToken(GlacierParser.ELSE, 0)
        ...
        def ifgdpats(self):
            return self.getTypedRuleContext(GlacierParser.IfgdpatsContext,0)


        def CASE(self):
            return self.getToken(GlacierParser.CASE, 0)

        def OF(self):
            return self.getToken(GlacierParser.OF, 0)

        def DO(self):
            return self.getToken(GlacierParser.DO, 0)

        def stmtlist(self):
            return self.getTypedRuleContext(GlacierParser.StmtlistContext,0)


        def MDO(self):
            return self.getToken(GlacierParser.MDO, 0)

        def aexp1(self):
            return self.getTypedRuleContext(GlacierParser.Aexp1Context,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_aexp
    ...
    def aexp(self):
        ...
        localctx = GlacierParser.AexpContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.enterOuterAlt(localctx, 4)
                self.state = 2149
                self.match(GlacierParser.ReverseSlash)
                self.state = 2150
                self.apats()
                self.state = 2151
                self.match(GlacierParser.Arrow)
                ...
                self.enterOuterAlt(localctx, 5)
                self.state = 2154
                self.match(GlacierParser.LET)
                self.state = 2155
                self.decllist()
                self.state = 2156
                self.match(GlacierParser.IN)
                self.state = 2157
                self.exp()
                pass
                ...
                self.enterOuterAlt(localctx, 6)
                self.state = 2159
                self.match(GlacierParser.LCASE)
                self.state = 2160
                self.alts()
                pass
                ...
                self.enterOuterAlt(localctx, 9)
                self.state = 2176
                self.match(GlacierParser.CASE)
                self.state = 2177
                self.exp()
                self.state = 2178
                self.match(GlacierParser.OF)
                self.state = 2179
                self.alts()
                pass
    ...
    class Aexp1Context(ParserRuleContext):
        ...
        def aexp2(self):
            return self.getTypedRuleContext(GlacierParser.Aexp2Context,0)


        def OCURLY(self, i:int=None):
            if i is None:
                return self.getTokens(GlacierParser.OCURLY)
            else:
                return self.getToken(GlacierParser.OCURLY, i)

        def CCURLY(self, i:int=None):
            if i is None:
                return self.getTokens(GlacierParser.CCURLY)
            else:
                return self.getToken(GlacierParser.CCURLY, i)

        def fbinds(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.FbindsContext)
            else:
                return self.getTypedRuleContext(GlacierParser.FbindsContext,i)


        def getRuleIndex(self):
            return GlacierParser.RULE_aexp1
    ...
    def aexp1(self):
        ...
        localctx = GlacierParser.Aexp1Context(self, self._ctx, self.state)
        ...
        try:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    self._errHandler.sync(self)
                    _la = self._input.LA(1)
                    if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.AS) | (1 << GlacierParser.HIDING) | (1 << GlacierParser.QUALIFIED) | (1 << GlacierParser.EXPORT) | (1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CAPI) | (1 << GlacierParser.JSCALL) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0) or ((((_la - 98)) & ~0x3f) == 0 and ((1 << (_la - 98)) & ((1 << (GlacierParser.DoubleDot - 98)) | (1 << (GlacierParser.OpenRoundBracket - 98)) | (1 << (GlacierParser.VARID - 98)) | (1 << (GlacierParser.CONID - 98)))) != 0):
                        self.state = 2190
                        self.fbinds()
    ...
    class Aexp2Context(ParserRuleContext):
        ...
        def qcon(self):
            return self.getTypedRuleContext(GlacierParser.QconContext,0)
        ...
        def literal(self):
            return self.getTypedRuleContext(GlacierParser.LiteralContext,0)
        ...
        def pfloat(self):
            return self.getTypedRuleContext(GlacierParser.PfloatContext,0)
        ...
        def texp(self):
            return self.getTypedRuleContext(GlacierParser.TexpContext,0)
        ...
        def tup_exprs(self):
            return self.getTypedRuleContext(GlacierParser.Tup_exprsContext,0)
        ...
        def list_hs(self):
            return self.getTypedRuleContext(GlacierParser.List_hsContext,0)
        ...
        def splice_typed(self):
            return self.getTypedRuleContext(GlacierParser.Splice_typedContext,0)
        ...
        def DoubleQuote(self):
            return self.getToken(GlacierParser.DoubleQuote, 0)
        ...
        def TopenExpQuote(self):
            return self.getToken(GlacierParser.TopenExpQuote, 0)
        ...
        def TcloseQoute(self):
            return self.getToken(GlacierParser.TcloseQoute, 0)

        def TopenTexpQuote(self):
            return self.getToken(GlacierParser.TopenTexpQuote, 0)

        def TcloseTExpQoute(self):
            return self.getToken(GlacierParser.TcloseTExpQoute, 0)

        def TopenTypQoute(self):
            return self.getToken(GlacierParser.TopenTypQoute, 0)
        ...
        def TopenPatQuote(self):
            return self.getToken(GlacierParser.TopenPatQuote, 0)
        ...
        def TopenDecQoute(self):
            return self.getToken(GlacierParser.TopenDecQoute, 0)

        def cvtopbody(self):
            return self.getTypedRuleContext(GlacierParser.CvtopbodyContext,0)
        ...
        def AopenParen(self, i:int=None):
            if i is None:
                return self.getTokens(GlacierParser.AopenParen)
            else:
                return self.getToken(GlacierParser.AopenParen, i)
        ...
        def cmdargs(self):
            return self.getTypedRuleContext(GlacierParser.CmdargsContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_aexp2
    ...
    def aexp2(self):
        ...
        localctx = GlacierParser.Aexp2Context(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.enterOuterAlt(localctx, 18)
                self.state = 2233
                self.match(GlacierParser.DoubleQuote)
                self.state = 2234
                self.tyvar()
                pass
                ...
                self.enterOuterAlt(localctx, 21)
                self.state = 2238
                self.match(GlacierParser.TopenExpQuote)
                self.state = 2239
                self.exp()
                self.state = 2240
                self.match(GlacierParser.TcloseQoute)
                pass

            elif la_ == 22:
                self.enterOuterAlt(localctx, 22)
                self.state = 2242
                self.match(GlacierParser.TopenTexpQuote)
                self.state = 2243
                self.exp()
                self.state = 2244
                self.match(GlacierParser.TcloseTExpQoute)
                pass

            elif la_ == 23:
                self.enterOuterAlt(localctx, 23)
                self.state = 2246
                self.match(GlacierParser.TopenTypQoute)
                self.state = 2247
                self.ktype()
                self.state = 2248
                self.match(GlacierParser.TcloseQoute)
                ...
                self.state = 2250
                self.match(GlacierParser.TopenPatQuote)
                self.state = 2251
                self.infixexp()
                self.state = 2252
                self.match(GlacierParser.TcloseQoute)
                ...
                self.state = 2254
                self.match(GlacierParser.TopenDecQoute)
                self.state = 2255
                self.cvtopbody()
                self.state = 2256
                self.match(GlacierParser.TcloseQoute)
                ...
                self.state = 2259
                self.match(GlacierParser.AopenParen)
                self.state = 2260
                self.aexp()
                self.state = 2262
                self._errHandler.sync(self)
    ...
    class Splice_expContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_splice_exp
    ...
    def splice_exp(self):
        ...
        localctx = GlacierParser.Splice_expContext(self, self._ctx, self.state)
        self.enterRule(localctx, 308, self.RULE_splice_exp)
        try:
            self.state = 2270
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [GlacierParser.DDollar]:
                self.enterOuterAlt(localctx, 1)
                self.state = 2268
                self.splice_typed()
                pass
            elif token in [GlacierParser.Dollar]:
                self.enterOuterAlt(localctx, 2)
                self.state = 2269
                self.splice_untyped()
                pass
    ...
    class Splice_untypedContext(ParserRuleContext):
        ...
        def Dollar(self):
            return self.getToken(GlacierParser.Dollar, 0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_splice_untyped
    ...
    def splice_untyped(self):
        ...
        localctx = GlacierParser.Splice_untypedContext(self, self._ctx, self.state)
        self.enterRule(localctx, 310, self.RULE_splice_untyped)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 2272
            self.match(GlacierParser.Dollar)
            self.state = 2273
            self.aexp()
        except RecognitionException as re:
            localctx.exception = re
    ...
    class Splice_typedContext(ParserRuleContext):
        ...
        def DDollar(self):
            return self.getToken(GlacierParser.DDollar, 0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_splice_typed
    ...
    def splice_typed(self):
        ...
        localctx = GlacierParser.Splice_typedContext(self, self._ctx, self.state)
        self.enterRule(localctx, 312, self.RULE_splice_typed)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 2275
            self.match(GlacierParser.DDollar)
            self.state = 2276
            self.aexp()
        except RecognitionException as re:
            localctx.exception = re
    ...
    class CmdargsContext(ParserRuleContext):
        ...
        def acmd(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.AcmdContext)
            else:
                return self.getTypedRuleContext(GlacierParser.AcmdContext,i)


        def getRuleIndex(self):
            return GlacierParser.RULE_cmdargs
    ...
    def cmdargs(self):
        ...
        localctx = GlacierParser.CmdargsContext(self, self._ctx, self.state)
    ...
    class AcmdContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_acmd
    ...
    def acmd(self):
        ...
        localctx = GlacierParser.AcmdContext(self, self._ctx, self.state)
    ...
    class CvtopbodyContext(ParserRuleContext):
        ...
        def cvtopdecls0(self):
            return self.getTypedRuleContext(GlacierParser.Cvtopdecls0Context,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_cvtopbody
    ...
    def cvtopbody(self):
        ...
        localctx = GlacierParser.CvtopbodyContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.NEWLINE) | (1 << GlacierParser.AS) | (1 << GlacierParser.CASE) | (1 << GlacierParser.CLASS) | (1 << GlacierParser.DATA) | (1 << GlacierParser.DEFAULT) | (1 << GlacierParser.DERIVING) | (1 << GlacierParser.DO) | (1 << GlacierParser.HIDING) | (1 << GlacierParser.IF) | (1 << GlacierParser.INFIX) | (1 << GlacierParser.INFIXL) | (1 << GlacierParser.INFIXR) | (1 << GlacierParser.INSTANCE) | (1 << GlacierParser.LET) | (1 << GlacierParser.NEWTYPE) | (1 << GlacierParser.QUALIFIED) | (1 << GlacierParser.TYPE) | (1 << GlacierParser.WILDCARD) | (1 << GlacierParser.FOREIGN) | (1 << GlacierParser.EXPORT) | (1 << GlacierParser.MDO) | (1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CAPI) | (1 << GlacierParser.JSCALL) | (1 << GlacierParser.PATTERN) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0) or ((((_la - 73)) & ~0x3f) == 0 and ((1 << (_la - 73)) & ((1 << (GlacierParser.LCASE - 73)) | (1 << (GlacierParser.Bang - 73)) | (1 << (GlacierParser.Minus - 73)) | (1 << (GlacierParser.Tilde - 73)) | (1 << (GlacierParser.DDollar - 73)) | (1 << (GlacierParser.Dollar - 73)) | (1 << (GlacierParser.Semi - 73)) | (1 << (GlacierParser.Quote - 73)) | (1 << (GlacierParser.DoubleQuote - 73)) | (1 << (GlacierParser.ReverseSlash - 73)) | (1 << (GlacierParser.AopenParen - 73)) | (1 << (GlacierParser.TopenTexpQuote - 73)) | (1 << (GlacierParser.TopenExpQuote - 73)) | (1 << (GlacierParser.TopenPatQuote - 73)) | (1 << (GlacierParser.TopenTypQoute - 73)) | (1 << (GlacierParser.TopenDecQoute - 73)) | (1 << (GlacierParser.OpenBoxParen - 73)) | (1 << (GlacierParser.OpenRoundBracket - 73)) | (1 << (GlacierParser.OpenSquareBracket - 73)) | (1 << (GlacierParser.CHAR - 73)) | (1 << (GlacierParser.STRING - 73)) | (1 << (GlacierParser.VARID - 73)) | (1 << (GlacierParser.CONID - 73)) | (1 << (GlacierParser.OpenPragmaBracket - 73)) | (1 << (GlacierParser.SEMI - 73)))) != 0) or ((((_la - 137)) & ~0x3f) == 0 and ((1 << (_la - 137)) & ((1 << (GlacierParser.DECIMAL - 137)) | (1 << (GlacierParser.OCTAL - 137)) | (1 << (GlacierParser.HEXADECIMAL - 137)) | (1 << (GlacierParser.FLOAT - 137)))) != 0):
                self.state = 2286
                self.cvtopdecls0()
    ...
    class Cvtopdecls0Context(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_cvtopdecls0
    ...
    def cvtopdecls0(self):
        ...
        localctx = GlacierParser.Cvtopdecls0Context(self, self._ctx, self.state)
    ...
    class TexpContext(ParserRuleContext):
        ...
        def qop(self):
            return self.getTypedRuleContext(GlacierParser.QopContext,0)


        def qopm(self):
            return self.getTypedRuleContext(GlacierParser.QopmContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_texp
    ...
    def texp(self):
        ...
        localctx = GlacierParser.TexpContext(self, self._ctx, self.state)
    ...
    class Tup_exprsContext(ParserRuleContext):
        ...
        def commas_tup_tail(self):
            return self.getTypedRuleContext(GlacierParser.Commas_tup_tailContext,0)


        def bars(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.BarsContext)
            else:
                return self.getTypedRuleContext(GlacierParser.BarsContext,i)


        def commas(self):
            return self.getTypedRuleContext(GlacierParser.CommasContext,0)


        def tup_tail(self):
            return self.getTypedRuleContext(GlacierParser.Tup_tailContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_tup_exprs
    ...
    def tup_exprs(self):
        ...
        localctx = GlacierParser.Tup_exprsContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.AS) | (1 << GlacierParser.CASE) | (1 << GlacierParser.DO) | (1 << GlacierParser.HIDING) | (1 << GlacierParser.IF) | (1 << GlacierParser.LET) | (1 << GlacierParser.QUALIFIED) | (1 << GlacierParser.WILDCARD) | (1 << GlacierParser.EXPORT) | (1 << GlacierParser.MDO) | (1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CAPI) | (1 << GlacierParser.JSCALL) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0) or ((((_la - 73)) & ~0x3f) == 0 and ((1 << (_la - 73)) & ((1 << (GlacierParser.LCASE - 73)) | (1 << (GlacierParser.Hash - 73)) | (1 << (GlacierParser.Less - 73)) | (1 << (GlacierParser.Greater - 73)) | (1 << (GlacierParser.Ampersand - 73)) | (1 << (GlacierParser.Pipe - 73)) | (1 << (GlacierParser.Bang - 73)) | (1 << (GlacierParser.Caret - 73)) | (1 << (GlacierParser.Plus - 73)) | (1 << (GlacierParser.Minus - 73)) | (1 << (GlacierParser.Asterisk - 73)) | (1 << (GlacierParser.Percent - 73)) | (1 << (GlacierParser.Divide - 73)) | (1 << (GlacierParser.Tilde - 73)) | (1 << (GlacierParser.Atsign - 73)) | (1 << (GlacierParser.DDollar - 73)) | (1 << (GlacierParser.Dollar - 73)) | (1 << (GlacierParser.Dot - 73)) | (1 << (GlacierParser.QuestionMark - 73)) | (1 << (GlacierParser.Colon - 73)) | (1 << (GlacierParser.Eq - 73)) | (1 << (GlacierParser.Quote - 73)) | (1 << (GlacierParser.DoubleQuote - 73)) | (1 << (GlacierParser.ReverseSlash - 73)) | (1 << (GlacierParser.BackQuote - 73)) | (1 << (GlacierParser.AopenParen - 73)) | (1 << (GlacierParser.TopenTexpQuote - 73)) | (1 << (GlacierParser.TopenExpQuote - 73)) | (1 << (GlacierParser.TopenPatQuote - 73)) | (1 << (GlacierParser.TopenTypQoute - 73)) | (1 << (GlacierParser.TopenDecQoute - 73)) | (1 << (GlacierParser.OpenBoxParen - 73)) | (1 << (GlacierParser.OpenRoundBracket - 73)) | (1 << (GlacierParser.OpenSquareBracket - 73)) | (1 << (GlacierParser.CHAR - 73)) | (1 << (GlacierParser.STRING - 73)) | (1 << (GlacierParser.VARID - 73)) | (1 << (GlacierParser.CONID - 73)))) != 0) or ((((_la - 137)) & ~0x3f) == 0 and ((1 << (_la - 137)) & ((1 << (GlacierParser.DECIMAL - 137)) | (1 << (GlacierParser.OCTAL - 137)) | (1 << (GlacierParser.HEXADECIMAL - 137)) | (1 << (GlacierParser.FLOAT - 137)))) != 0):
                    self.state = 2318
                    self.tup_tail()
    ...
    class Commas_tup_tailContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_commas_tup_tail
    ...
    def commas_tup_tail(self):
        ...
        localctx = GlacierParser.Commas_tup_tailContext(self, self._ctx, self.state)
    ...
    class Tup_tailContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_tup_tail
    ...
    def tup_tail(self):
        ...
        localctx = GlacierParser.Tup_tailContext(self, self._ctx, self.state)
    ...
    class List_hsContext(ParserRuleContext):
        ...
        def lexps(self):
            return self.getTypedRuleContext(GlacierParser.LexpsContext,0)
        ...
        def flattenedpquals(self):
            return self.getTypedRuleContext(GlacierParser.FlattenedpqualsContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_list_hs

        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterList_hs" ):
                listener.enterList_hs(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitList_hs" ):
                listener.exitList_hs(self)
    ...
    def list_hs(self):
        ...
        localctx = GlacierParser.List_hsContext(self, self._ctx, self.state)
        self.enterRule(localctx, 330, self.RULE_list_hs)
        try:
            self.state = 2362
            self._errHandler.sync(self)
    ...
    class LexpsContext(ParserRuleContext):
        ...
        def texp(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.TexpContext)
            else:
                return self.getTypedRuleContext(GlacierParser.TexpContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_lexps
    ...
    def lexps(self):
        ...
        localctx = GlacierParser.LexpsContext(self, self._ctx, self.state)
    ...
    class FlattenedpqualsContext(ParserRuleContext):
        ...
        def pquals(self):
            return self.getTypedRuleContext(GlacierParser.PqualsContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_flattenedpquals
    ...
    def flattenedpquals(self):
        ...
        localctx = GlacierParser.FlattenedpqualsContext(self, self._ctx, self.state)
    ...
    class PqualsContext(ParserRuleContext):
        ...
        def squals(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.SqualsContext)
            else:
                return self.getTypedRuleContext(GlacierParser.SqualsContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_pquals
    ...
    def pquals(self):
        ...
        localctx = GlacierParser.PqualsContext(self, self._ctx, self.state)
    ...
    class SqualsContext(ParserRuleContext):
        ...
        def transformqual(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.TransformqualContext)
            else:
                return self.getTypedRuleContext(GlacierParser.TransformqualContext,i)
        ...
        def qual(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.QualContext)
            else:
                return self.getTypedRuleContext(GlacierParser.QualContext,i)


        def getRuleIndex(self):
            return GlacierParser.RULE_squals
    ...
    def squals(self):
        ...
        localctx = GlacierParser.SqualsContext(self, self._ctx, self.state)
    ...
    class TransformqualContext(ParserRuleContext):
        ...
        def BY(self):
            return self.getToken(GlacierParser.BY, 0)

        def GROUP(self):
            return self.getToken(GlacierParser.GROUP, 0)

        def USING(self):
            return self.getToken(GlacierParser.USING, 0)

        def getRuleIndex(self):
            return GlacierParser.RULE_transformqual
    ...
    def transformqual(self):
        ...
        localctx = GlacierParser.TransformqualContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.match(GlacierParser.THEN)
                self.state = 2426
                self.match(GlacierParser.GROUP)
                self.state = 2427
                self.match(GlacierParser.USING)
                self.state = 2428
                self.exp()
                pass
    ...
    class GuardsContext(ParserRuleContext):
        ...
        def guard(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.GuardContext)
            else:
                return self.getTypedRuleContext(GlacierParser.GuardContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_guards
    ...
    def guards(self):
        ...
        localctx = GlacierParser.GuardsContext(self, self._ctx, self.state)
    ...
    class GuardContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_guard
    ...
    def guard(self):
        ...
        localctx = GlacierParser.GuardContext(self, self._ctx, self.state)
    ...
    class AltsContext(ParserRuleContext):
        ...
        def alt(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.AltContext)
            else:
                return self.getTypedRuleContext(GlacierParser.AltContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_alts
    ...
    def alts(self):
        ...
        localctx = GlacierParser.AltsContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                while True:
                    ...
                    self._errHandler.sync(self)
                    _la = self._input.LA(1)
                    if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.AS) | (1 << GlacierParser.CASE) | (1 << GlacierParser.DO) | (1 << GlacierParser.HIDING) | (1 << GlacierParser.IF) | (1 << GlacierParser.LET) | (1 << GlacierParser.QUALIFIED) | (1 << GlacierParser.WILDCARD) | (1 << GlacierParser.EXPORT) | (1 << GlacierParser.MDO) | (1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CAPI) | (1 << GlacierParser.JSCALL) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0) or ((((_la - 73)) & ~0x3f) == 0 and ((1 << (_la - 73)) & ((1 << (GlacierParser.LCASE - 73)) | (1 << (GlacierParser.Bang - 73)) | (1 << (GlacierParser.Minus - 73)) | (1 << (GlacierParser.Tilde - 73)) | (1 << (GlacierParser.DDollar - 73)) | (1 << (GlacierParser.Dollar - 73)) | (1 << (GlacierParser.Quote - 73)) | (1 << (GlacierParser.DoubleQuote - 73)) | (1 << (GlacierParser.ReverseSlash - 73)) | (1 << (GlacierParser.AopenParen - 73)) | (1 << (GlacierParser.TopenTexpQuote - 73)) | (1 << (GlacierParser.TopenExpQuote - 73)) | (1 << (GlacierParser.TopenPatQuote - 73)) | (1 << (GlacierParser.TopenTypQoute - 73)) | (1 << (GlacierParser.TopenDecQoute - 73)) | (1 << (GlacierParser.OpenBoxParen - 73)) | (1 << (GlacierParser.OpenRoundBracket - 73)) | (1 << (GlacierParser.OpenSquareBracket - 73)) | (1 << (GlacierParser.CHAR - 73)) | (1 << (GlacierParser.STRING - 73)) | (1 << (GlacierParser.VARID - 73)) | (1 << (GlacierParser.CONID - 73)))) != 0) or ((((_la - 137)) & ~0x3f) == 0 and ((1 << (_la - 137)) & ((1 << (GlacierParser.DECIMAL - 137)) | (1 << (GlacierParser.OCTAL - 137)) | (1 << (GlacierParser.HEXADECIMAL - 137)) | (1 << (GlacierParser.FLOAT - 137)))) != 0)):
                        break
    ...
    class AltContext(ParserRuleContext):
        ...
        def alt_rhs(self):
            return self.getTypedRuleContext(GlacierParser.Alt_rhsContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_alt
    ...
    def alt(self):
        ...
        localctx = GlacierParser.AltContext(self, self._ctx, self.state)
    ...
    class Alt_rhsContext(ParserRuleContext):
        ...
        def ralt(self):
            return self.getTypedRuleContext(GlacierParser.RaltContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_alt_rhs
    ...
    def alt_rhs(self):
        ...
        localctx = GlacierParser.Alt_rhsContext(self, self._ctx, self.state)
    ...
    class RaltContext(ParserRuleContext):
        ...
        def gdpats(self):
            return self.getTypedRuleContext(GlacierParser.GdpatsContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_ralt
    ...
    def ralt(self):
        ...
        localctx = GlacierParser.RaltContext(self, self._ctx, self.state)
        self.enterRule(localctx, 352, self.RULE_ralt)
        try:
            self.state = 2484
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [GlacierParser.Arrow]:
                self.enterOuterAlt(localctx, 1)
                self.state = 2481
                self.match(GlacierParser.Arrow)
                self.state = 2482
    ...
    class GdpatsContext(ParserRuleContext):
        ...
        def gdpat(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.GdpatContext)
            else:
                return self.getTypedRuleContext(GlacierParser.GdpatContext,i)


        def getRuleIndex(self):
            return GlacierParser.RULE_gdpats
    ...
    def gdpats(self):
        ...
        localctx = GlacierParser.GdpatsContext(self, self._ctx, self.state)
    ...
    class IfgdpatsContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_ifgdpats
    ...
    def ifgdpats(self):
        ...
        localctx = GlacierParser.IfgdpatsContext(self, self._ctx, self.state)
        self.enterRule(localctx, 356, self.RULE_ifgdpats)
        try:
            self.state = 2496
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [GlacierParser.OCURLY]:
                self.enterOuterAlt(localctx, 1)
                self.state = 2491
                self.match(GlacierParser.OCURLY)
                self.state = 2492
    ...
    class GdpatContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_gdpat
    ...
    def gdpat(self):
        ...
        localctx = GlacierParser.GdpatContext(self, self._ctx, self.state)
    ...
    def pat(self):
        ...
        localctx = GlacierParser.PatContext(self, self._ctx, self.state)
    ...
    class BindpatContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_bindpat
    ...
    def bindpat(self):
        ...
        localctx = GlacierParser.BindpatContext(self, self._ctx, self.state)
    ...
    class ApatContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_apat
    ...
    def apat(self):
        ...
        localctx = GlacierParser.ApatContext(self, self._ctx, self.state)
    ...
    class ApatsContext(ParserRuleContext):
        ...
        def apat(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.ApatContext)
            else:
                return self.getTypedRuleContext(GlacierParser.ApatContext,i)


        def getRuleIndex(self):
            return GlacierParser.RULE_apats
    ...
    def apats(self):
        ...
        localctx = GlacierParser.ApatsContext(self, self._ctx, self.state)
        ...
        try:
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.AS) | (1 << GlacierParser.CASE) | (1 << GlacierParser.DO) | (1 << GlacierParser.HIDING) | (1 << GlacierParser.IF) | (1 << GlacierParser.LET) | (1 << GlacierParser.QUALIFIED) | (1 << GlacierParser.WILDCARD) | (1 << GlacierParser.EXPORT) | (1 << GlacierParser.MDO) | (1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CAPI) | (1 << GlacierParser.JSCALL) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0) or ((((_la - 73)) & ~0x3f) == 0 and ((1 << (_la - 73)) & ((1 << (GlacierParser.LCASE - 73)) | (1 << (GlacierParser.Bang - 73)) | (1 << (GlacierParser.Tilde - 73)) | (1 << (GlacierParser.DDollar - 73)) | (1 << (GlacierParser.Dollar - 73)) | (1 << (GlacierParser.Quote - 73)) | (1 << (GlacierParser.DoubleQuote - 73)) | (1 << (GlacierParser.ReverseSlash - 73)) | (1 << (GlacierParser.AopenParen - 73)) | (1 << (GlacierParser.TopenTexpQuote - 73)) | (1 << (GlacierParser.TopenExpQuote - 73)) | (1 << (GlacierParser.TopenPatQuote - 73)) | (1 << (GlacierParser.TopenTypQoute - 73)) | (1 << (GlacierParser.TopenDecQoute - 73)) | (1 << (GlacierParser.OpenBoxParen - 73)) | (1 << (GlacierParser.OpenRoundBracket - 73)) | (1 << (GlacierParser.OpenSquareBracket - 73)) | (1 << (GlacierParser.CHAR - 73)) | (1 << (GlacierParser.STRING - 73)) | (1 << (GlacierParser.VARID - 73)) | (1 << (GlacierParser.CONID - 73)))) != 0) or ((((_la - 137)) & ~0x3f) == 0 and ((1 << (_la - 137)) & ((1 << (GlacierParser.DECIMAL - 137)) | (1 << (GlacierParser.OCTAL - 137)) | (1 << (GlacierParser.HEXADECIMAL - 137)) | (1 << (GlacierParser.FLOAT - 137)))) != 0)):
                    break
    ...
    class FpatContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_fpat
    ...
    def fpat(self):
        ...
        localctx = GlacierParser.FpatContext(self, self._ctx, self.state)
    ...
    class StmtlistContext(ParserRuleContext):
        ...
        def stmts(self):
            return self.getTypedRuleContext(GlacierParser.StmtsContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_stmtlist
    ...
    def stmtlist(self):
        ...
        localctx = GlacierParser.StmtlistContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.AS) | (1 << GlacierParser.CASE) | (1 << GlacierParser.DO) | (1 << GlacierParser.HIDING) | (1 << GlacierParser.IF) | (1 << GlacierParser.LET) | (1 << GlacierParser.QUALIFIED) | (1 << GlacierParser.WILDCARD) | (1 << GlacierParser.EXPORT) | (1 << GlacierParser.MDO) | (1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CAPI) | (1 << GlacierParser.JSCALL) | (1 << GlacierParser.REC) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0) or ((((_la - 73)) & ~0x3f) == 0 and ((1 << (_la - 73)) & ((1 << (GlacierParser.LCASE - 73)) | (1 << (GlacierParser.Bang - 73)) | (1 << (GlacierParser.Minus - 73)) | (1 << (GlacierParser.Tilde - 73)) | (1 << (GlacierParser.DDollar - 73)) | (1 << (GlacierParser.Dollar - 73)) | (1 << (GlacierParser.Semi - 73)) | (1 << (GlacierParser.Quote - 73)) | (1 << (GlacierParser.DoubleQuote - 73)) | (1 << (GlacierParser.ReverseSlash - 73)) | (1 << (GlacierParser.AopenParen - 73)) | (1 << (GlacierParser.TopenTexpQuote - 73)) | (1 << (GlacierParser.TopenExpQuote - 73)) | (1 << (GlacierParser.TopenPatQuote - 73)) | (1 << (GlacierParser.TopenTypQoute - 73)) | (1 << (GlacierParser.TopenDecQoute - 73)) | (1 << (GlacierParser.OpenBoxParen - 73)) | (1 << (GlacierParser.OpenRoundBracket - 73)) | (1 << (GlacierParser.OpenSquareBracket - 73)) | (1 << (GlacierParser.CHAR - 73)) | (1 << (GlacierParser.STRING - 73)) | (1 << (GlacierParser.VARID - 73)) | (1 << (GlacierParser.CONID - 73)) | (1 << (GlacierParser.SEMI - 73)))) != 0) or ((((_la - 137)) & ~0x3f) == 0 and ((1 << (_la - 137)) & ((1 << (GlacierParser.DECIMAL - 137)) | (1 << (GlacierParser.OCTAL - 137)) | (1 << (GlacierParser.HEXADECIMAL - 137)) | (1 << (GlacierParser.FLOAT - 137)))) != 0):
                self.state = 2519
                self.stmts()
    ...
    class StmtsContext(ParserRuleContext):
        ...
        def stmt(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.StmtContext)
            else:
                return self.getTypedRuleContext(GlacierParser.StmtContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_stmts
    ...
    def stmts(self):
        ...
        localctx = GlacierParser.StmtsContext(self, self._ctx, self.state)
    ...
    class StmtContext(ParserRuleContext):
        ...
        def qual(self):
            return self.getTypedRuleContext(GlacierParser.QualContext,0)


        def REC(self):
            return self.getToken(GlacierParser.REC, 0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_stmt
    ...
    def stmt(self):
        ...
        localctx = GlacierParser.StmtContext(self, self._ctx, self.state)
        self.enterRule(localctx, 374, self.RULE_stmt)
        try:
            self.state = 2551
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [GlacierParser.AS, GlacierParser.CASE, GlacierParser.DO, GlacierParser.HIDING, GlacierParser.IF, GlacierParser.LET, GlacierParser.QUALIFIED, GlacierParser.WILDCARD, GlacierParser.EXPORT, GlacierParser.MDO, GlacierParser.STDCALL, GlacierParser.CCALL, GlacierParser.CAPI, GlacierParser.JSCALL, GlacierParser.STOCK, GlacierParser.ANYCLASS, GlacierParser.VIA, GlacierParser.LCASE, GlacierParser.Bang, GlacierParser.Minus, GlacierParser.Tilde, GlacierParser.DDollar, GlacierParser.Dollar, GlacierParser.Quote, GlacierParser.DoubleQuote, GlacierParser.ReverseSlash, GlacierParser.AopenParen, GlacierParser.TopenTexpQuote, GlacierParser.TopenExpQuote, GlacierParser.TopenPatQuote, GlacierParser.TopenTypQoute, GlacierParser.TopenDecQoute, GlacierParser.OpenBoxParen, GlacierParser.OpenRoundBracket, GlacierParser.OpenSquareBracket, GlacierParser.CHAR, GlacierParser.STRING, GlacierParser.VARID, GlacierParser.CONID, GlacierParser.DECIMAL, GlacierParser.OCTAL, GlacierParser.HEXADECIMAL, GlacierParser.FLOAT]:
                self.enterOuterAlt(localctx, 1)
                self.state = 2543
                self.qual()
                pass
            elif token in [GlacierParser.REC]:
                self.enterOuterAlt(localctx, 2)
                self.state = 2544
                self.match(GlacierParser.REC)
                self.state = 2545
                self.stmtlist()
                pass
            elif token in [GlacierParser.Semi, GlacierParser.SEMI]:
    ...
    class QualContext(ParserRuleContext):
        ...
        def bindpat(self):
            return self.getTypedRuleContext(GlacierParser.BindpatContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_qual
    ...
    def qual(self):
        ...
        localctx = GlacierParser.QualContext(self, self._ctx, self.state)
    ...
    class FbindsContext(ParserRuleContext):
        ...
        def fbind(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.FbindContext)
            else:
                return self.getTypedRuleContext(GlacierParser.FbindContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_fbinds
    ...
    def fbinds(self):
        ...
        localctx = GlacierParser.FbindsContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [GlacierParser.AS, GlacierParser.HIDING, GlacierParser.QUALIFIED, GlacierParser.EXPORT, GlacierParser.STDCALL, GlacierParser.CCALL, GlacierParser.CAPI, GlacierParser.JSCALL, GlacierParser.STOCK, GlacierParser.ANYCLASS, GlacierParser.VIA, GlacierParser.OpenRoundBracket, GlacierParser.VARID, GlacierParser.CONID]:
                self.enterOuterAlt(localctx, 1)
                self.state = 2562
                self.fbind()
                self.state = 2567
                ...
                pass
            elif token in [GlacierParser.DoubleDot]:
                self.enterOuterAlt(localctx, 2)
                self.state = 2570
                self.match(GlacierParser.DoubleDot)
                pass
    ...
    class FbindContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_fbind
    ...
    def fbind(self):
        ...
        localctx = GlacierParser.FbindContext(self, self._ctx, self.state)
    ...
    class DbindsContext(ParserRuleContext):
        ...
        def dbind(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.DbindContext)
            else:
                return self.getTypedRuleContext(GlacierParser.DbindContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_dbinds
    ...
    def dbinds(self):
        ...
        localctx = GlacierParser.DbindsContext(self, self._ctx, self.state)
    ...
    class DbindContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_dbind
    ...
    def dbind(self):
        ...
        localctx = GlacierParser.DbindContext(self, self._ctx, self.state)
    ...
    class Name_boolformula_optContext(ParserRuleContext):
        ...
        def name_boolformula_and(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.Name_boolformula_andContext)
            else:
                return self.getTypedRuleContext(GlacierParser.Name_boolformula_andContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_name_boolformula_opt
    ...
    def name_boolformula_opt(self):
        ...
        localctx = GlacierParser.Name_boolformula_optContext(self, self._ctx, self.state)
    ...
    class Name_boolformula_andContext(ParserRuleContext):
        ...
        def name_boolformula_and_list(self):
            return self.getTypedRuleContext(GlacierParser.Name_boolformula_and_listContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_name_boolformula_and
    ...
    def name_boolformula_and(self):
        ...
        localctx = GlacierParser.Name_boolformula_andContext(self, self._ctx, self.state)
    ...
    class Name_boolformula_and_listContext(ParserRuleContext):
        ...
        def name_boolformula_atom(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.Name_boolformula_atomContext)
            else:
                return self.getTypedRuleContext(GlacierParser.Name_boolformula_atomContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_name_boolformula_and_list
    ...
    def name_boolformula_and_list(self):
        ...
        localctx = GlacierParser.Name_boolformula_and_listContext(self, self._ctx, self.state)
    ...
    class Name_boolformula_atomContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_name_boolformula_atom
    ...
    def name_boolformula_atom(self):
        ...
        localctx = GlacierParser.Name_boolformula_atomContext(self, self._ctx, self.state)
    ...
    class NamelistContext(ParserRuleContext):
        ...
        def name_var(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.Name_varContext)
            else:
                return self.getTypedRuleContext(GlacierParser.Name_varContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_namelist
    ...
    def namelist(self):
        ...
        localctx = GlacierParser.NamelistContext(self, self._ctx, self.state)
    ...
    class Name_varContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_name_var
    ...
    def name_var(self):
        ...
        localctx = GlacierParser.Name_varContext(self, self._ctx, self.state)
    ...
    class Qcon_nowiredlistContext(ParserRuleContext):
        ...
        def gen_qcon(self):
            return self.getTypedRuleContext(GlacierParser.Gen_qconContext,0)


        def sysdcon_nolist(self):
            return self.getTypedRuleContext(GlacierParser.Sysdcon_nolistContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_qcon_nowiredlist
    ...
    def qcon_nowiredlist(self):
        ...
        localctx = GlacierParser.Qcon_nowiredlistContext(self, self._ctx, self.state)
    ...
    class QconContext(ParserRuleContext):
        ...
        def sysdcon(self):
            return self.getTypedRuleContext(GlacierParser.SysdconContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_qcon
    ...
    def qcon(self):
        ...
        localctx = GlacierParser.QconContext(self, self._ctx, self.state)
    ...
    class Gen_qconContext(ParserRuleContext):
        ...
        def qconid(self):
            return self.getTypedRuleContext(GlacierParser.QconidContext,0)
        ...
        def qconsym(self):
            return self.getTypedRuleContext(GlacierParser.QconsymContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_gen_qcon
    ...
    def gen_qcon(self):
        ...
        localctx = GlacierParser.Gen_qconContext(self, self._ctx, self.state)
        self.enterRule(localctx, 402, self.RULE_gen_qcon)
        try:
            self.state = 2648
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [GlacierParser.CONID]:
                self.enterOuterAlt(localctx, 1)
                self.state = 2643
                self.qconid()
                pass
    ...
    class ConContext(ParserRuleContext):
        ...
        def conid(self):
            return self.getTypedRuleContext(GlacierParser.ConidContext,0)
        ...
        def consym(self):
            return self.getTypedRuleContext(GlacierParser.ConsymContext,0)
    ...
    def con(self):
        ...
        localctx = GlacierParser.ConContext(self, self._ctx, self.state)
    ...
    class Con_listContext(ParserRuleContext):
        ...
        def con(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.ConContext)
            else:
                return self.getTypedRuleContext(GlacierParser.ConContext,i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_con_list
    ...
    def con_list(self):
        ...
        localctx = GlacierParser.Con_listContext(self, self._ctx, self.state)
    ...
    class Sysdcon_nolistContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_sysdcon_nolist
    ...
    def sysdcon_nolist(self):
        ...
        localctx = GlacierParser.Sysdcon_nolistContext(self, self._ctx, self.state)
    ...
    class SysdconContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_sysdcon
    ...
    def sysdcon(self):
        ...
        localctx = GlacierParser.SysdconContext(self, self._ctx, self.state)
        self.enterRule(localctx, 410, self.RULE_sysdcon)
        try:
            self.state = 2683
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [GlacierParser.OpenBoxParen, GlacierParser.OpenRoundBracket]:
                self.enterOuterAlt(localctx, 1)
                self.state = 2680
                self.sysdcon_nolist()
                pass
    ...
    class ConopContext(ParserRuleContext):
        ...
        def BackQuote(self, i:int=None):
            if i is None:
                return self.getTokens(GlacierParser.BackQuote)
            else:
                return self.getToken(GlacierParser.BackQuote, i)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_conop
    ...
    def conop(self):
        ...
        localctx = GlacierParser.ConopContext(self, self._ctx, self.state)
        self.enterRule(localctx, 412, self.RULE_conop)
        try:
            self.state = 2690
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [GlacierParser.Colon]:
                self.enterOuterAlt(localctx, 1)
                self.state = 2685
                self.consym()
                pass
            elif token in [GlacierParser.BackQuote]:
                self.enterOuterAlt(localctx, 2)
                self.state = 2686
                self.match(GlacierParser.BackQuote)
                self.state = 2687
                self.conid()
                self.state = 2688
                self.match(GlacierParser.BackQuote)
    ...
    class QconopContext(ParserRuleContext):
        ...
        def gconsym(self):
            return self.getTypedRuleContext(GlacierParser.GconsymContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_qconop
    ...
    def qconop(self):
        ...
        localctx = GlacierParser.QconopContext(self, self._ctx, self.state)
        self.enterRule(localctx, 414, self.RULE_qconop)
        try:
            self.state = 2697
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [GlacierParser.Colon, GlacierParser.CONID]:
                self.enterOuterAlt(localctx, 1)
                self.state = 2692
                self.gconsym()
                pass
    ...
    class GconsymContext(ParserRuleContext):
        ...
        def Colon(self):
            return self.getToken(GlacierParser.Colon, 0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_gconsym
    ...
    def gconsym(self):
        ...
        localctx = GlacierParser.GconsymContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                self.enterOuterAlt(localctx, 1)
                self.state = 2699
                self.match(GlacierParser.Colon)
                pass
    ...
    class GtyconContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_gtycon
    ...
    def gtycon(self):
        ...
        localctx = GlacierParser.GtyconContext(self, self._ctx, self.state)
    ...
    class NtgtyconContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_ntgtycon
    ...
    def ntgtycon(self):
        ...
        localctx = GlacierParser.NtgtyconContext(self, self._ctx, self.state)
    ...
    class OqtyconContext(ParserRuleContext):
        ...
        def qtyconsym(self):
            return self.getTypedRuleContext(GlacierParser.QtyconsymContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_oqtycon
    ...
    def oqtycon(self):
        ...
        localctx = GlacierParser.OqtyconContext(self, self._ctx, self.state)
    ...
    class QtyconopContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_qtyconop
    ...
    def qtyconop(self):
        ...
        localctx = GlacierParser.QtyconopContext(self, self._ctx, self.state)
        self.enterRule(localctx, 424, self.RULE_qtyconop)
        try:
            self.state = 2738
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [GlacierParser.Hash, GlacierParser.Less, GlacierParser.Greater, GlacierParser.Ampersand, GlacierParser.Pipe, GlacierParser.Bang, GlacierParser.Caret, GlacierParser.Plus, GlacierParser.Minus, GlacierParser.Asterisk, GlacierParser.Percent, GlacierParser.Divide, GlacierParser.Tilde, GlacierParser.Atsign, GlacierParser.Dollar, GlacierParser.Dot, GlacierParser.QuestionMark, GlacierParser.Colon, GlacierParser.Eq, GlacierParser.ReverseSlash, GlacierParser.CONID]:
                self.enterOuterAlt(localctx, 1)
                self.state = 2733
                self.qtyconsym()
                pass
    ...
    class QtyconContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_qtycon
    ...
    def qtycon(self):
        ...
        localctx = GlacierParser.QtyconContext(self, self._ctx, self.state)
    ...
    class TyconContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_tycon
    ...
    def tycon(self):
        ...
        localctx = GlacierParser.TyconContext(self, self._ctx, self.state)
    ...
    class QtyconsymContext(ParserRuleContext):
        ...
        def qvarsym(self):
            return self.getTypedRuleContext(GlacierParser.QvarsymContext,0)


        def tyconsym(self):
            return self.getTypedRuleContext(GlacierParser.TyconsymContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_qtyconsym
    ...
    def qtyconsym(self):
        ...
        localctx = GlacierParser.QtyconsymContext(self, self._ctx, self.state)
    ...
    class TyconsymContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_tyconsym
    ...
    def tyconsym(self):
        ...
        localctx = GlacierParser.TyconsymContext(self, self._ctx, self.state)
    ...
    def op(self):
        ...
        localctx = GlacierParser.OpContext(self, self._ctx, self.state)
    ...
    class VaropContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_varop
    ...
    def varop(self):
        ...
        localctx = GlacierParser.VaropContext(self, self._ctx, self.state)
        self.enterRule(localctx, 436, self.RULE_varop)
        try:
            self.state = 2770
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [GlacierParser.Hash, GlacierParser.Less, GlacierParser.Greater, GlacierParser.Ampersand, GlacierParser.Pipe, GlacierParser.Bang, GlacierParser.Caret, GlacierParser.Plus, GlacierParser.Minus, GlacierParser.Asterisk, GlacierParser.Percent, GlacierParser.Divide, GlacierParser.Tilde, GlacierParser.Atsign, GlacierParser.Dollar, GlacierParser.Dot, GlacierParser.QuestionMark, GlacierParser.Colon, GlacierParser.Eq, GlacierParser.ReverseSlash]:
                self.enterOuterAlt(localctx, 1)
                self.state = 2765
                self.varsym()
                pass
    ...
    class QopContext(ParserRuleContext):
        ...
        def qvarop(self):
            return self.getTypedRuleContext(GlacierParser.QvaropContext,0)
    ...
    def qop(self):
        ...
        localctx = GlacierParser.QopContext(self, self._ctx, self.state)
    ...
    class QopmContext(ParserRuleContext):
        ...
        def qvaropm(self):
            return self.getTypedRuleContext(GlacierParser.QvaropmContext,0)
        ...
        def hole_op(self):
            return self.getTypedRuleContext(GlacierParser.Hole_opContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_qopm
    ...
    def qopm(self):
        ...
        localctx = GlacierParser.QopmContext(self, self._ctx, self.state)
    ...
    class Hole_opContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_hole_op
    ...
    def hole_op(self):
        ...
        localctx = GlacierParser.Hole_opContext(self, self._ctx, self.state)
    ...
    class QvaropContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_qvarop
    ...
    def qvarop(self):
        ...
        localctx = GlacierParser.QvaropContext(self, self._ctx, self.state)
    ...
    class QvaropmContext(ParserRuleContext):
        ...
        def qvarsym_no_minus(self):
            return self.getTypedRuleContext(GlacierParser.Qvarsym_no_minusContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_qvaropm
    ...
    def qvaropm(self):
        ...
        localctx = GlacierParser.QvaropmContext(self, self._ctx, self.state)
    ...
    class TyvarContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_tyvar
    ...
    def tyvar(self):
        ...
        localctx = GlacierParser.TyvarContext(self, self._ctx, self.state)
    ...
    class TyvaropContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_tyvarop
    ...
    def tyvarop(self):
        ...
        localctx = GlacierParser.TyvaropContext(self, self._ctx, self.state)
    ...
    class TyvaridContext(ParserRuleContext):
        ...
        def special_id(self):
            return self.getTypedRuleContext(GlacierParser.Special_idContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_tyvarid
    ...
    def tyvarid(self):
        ...
        localctx = GlacierParser.TyvaridContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.enterOuterAlt(localctx, 3)
                self.state = 2807
                self.match(GlacierParser.UNSAFE)
                pass

            elif la_ == 4:
                self.enterOuterAlt(localctx, 4)
                self.state = 2808
                self.match(GlacierParser.SAFE)
                pass

            elif la_ == 5:
                self.enterOuterAlt(localctx, 5)
                self.state = 2809
                self.match(GlacierParser.INTERRUPTIBLE)
                pass
    ...
    class TyclsContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_tycls
    ...
    def tycls(self):
        ...
        localctx = GlacierParser.TyclsContext(self, self._ctx, self.state)
    ...
    class QtyclsContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_qtycls
    ...
    def qtycls(self):
        ...
        localctx = GlacierParser.QtyclsContext(self, self._ctx, self.state)
    ...
    def var(self):
        ...
        localctx = GlacierParser.VarContext(self, self._ctx, self.state)
    ...
    class QvarContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_qvar
    ...
    def qvar(self):
        ...
        localctx = GlacierParser.QvarContext(self, self._ctx, self.state)
        self.enterRule(localctx, 460, self.RULE_qvar)
        try:
            self.state = 2833
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [GlacierParser.AS, GlacierParser.HIDING, GlacierParser.QUALIFIED, GlacierParser.EXPORT, GlacierParser.STDCALL, GlacierParser.CCALL, GlacierParser.CAPI, GlacierParser.JSCALL, GlacierParser.STOCK, GlacierParser.ANYCLASS, GlacierParser.VIA, GlacierParser.VARID, GlacierParser.CONID]:
                self.enterOuterAlt(localctx, 1)
                self.state = 2828
                self.qvarid()
                pass
    ...
    class QvaridContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_qvarid
    ...
    def qvarid(self):
        ...
        localctx = GlacierParser.QvaridContext(self, self._ctx, self.state)
    ...
    class VaridContext(ParserRuleContext):
        ...
        def VARID(self):
            return self.getToken(GlacierParser.VARID, 0)
        ...
        def Hash(self, i:int=None):
            if i is None:
                return self.getTokens(GlacierParser.Hash)
            else:
                return self.getToken(GlacierParser.Hash, i)

        def getRuleIndex(self):
            return GlacierParser.RULE_varid
    ...
    def varid(self):
        ...
        localctx = GlacierParser.VaridContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [GlacierParser.VARID]:
                self.state = 2842
                self.match(GlacierParser.VARID)
                pass
            elif token in [GlacierParser.AS, GlacierParser.HIDING, GlacierParser.QUALIFIED, GlacierParser.EXPORT, GlacierParser.STDCALL, GlacierParser.CCALL, GlacierParser.CAPI, GlacierParser.JSCALL, GlacierParser.STOCK, GlacierParser.ANYCLASS, GlacierParser.VIA]:
                self.state = 2843
                self.special_id()
                pass
            else:
    ...
    class QvarsymContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_qvarsym
    ...
    def qvarsym(self):
        ...
        localctx = GlacierParser.QvarsymContext(self, self._ctx, self.state)
    ...
    class Qvarsym_no_minusContext(ParserRuleContext):
        ...
        def varsym_no_minus(self):
            return self.getTypedRuleContext(GlacierParser.Varsym_no_minusContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_qvarsym_no_minus
    ...
    def qvarsym_no_minus(self):
        ...
        localctx = GlacierParser.Qvarsym_no_minusContext(self, self._ctx, self.state)
    ...
    class VarsymContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_varsym
    ...
    def varsym(self):
        ...
        localctx = GlacierParser.VarsymContext(self, self._ctx, self.state)
        self.enterRule(localctx, 470, self.RULE_varsym)
        try:
            self.state = 2865
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [GlacierParser.Hash, GlacierParser.Less, GlacierParser.Greater, GlacierParser.Ampersand, GlacierParser.Pipe, GlacierParser.Bang, GlacierParser.Caret, GlacierParser.Plus, GlacierParser.Asterisk, GlacierParser.Percent, GlacierParser.Divide, GlacierParser.Tilde, GlacierParser.Atsign, GlacierParser.Dollar, GlacierParser.Dot, GlacierParser.QuestionMark, GlacierParser.Colon, GlacierParser.Eq, GlacierParser.ReverseSlash]:
                self.enterOuterAlt(localctx, 1)
                self.state = 2863
                self.varsym_no_minus()
                pass
            elif token in [GlacierParser.Minus]:
                self.enterOuterAlt(localctx, 2)
                self.state = 2864
                self.match(GlacierParser.Minus)
                pass
    ...
    class Varsym_no_minusContext(ParserRuleContext):
        ...
        def ascSymbol(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(GlacierParser.AscSymbolContext)
            else:
                return self.getTypedRuleContext(GlacierParser.AscSymbolContext,i)


        def getRuleIndex(self):
            return GlacierParser.RULE_varsym_no_minus
    ...
    def varsym_no_minus(self):
        ...
        localctx = GlacierParser.Varsym_no_minusContext(self, self._ctx, self.state)
    ...
    class Special_idContext(ParserRuleContext):
        ...
        def CAPI(self):
            return self.getToken(GlacierParser.CAPI, 0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_special_id
    ...
    def special_id(self):
        ...
        localctx = GlacierParser.Special_idContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.state = 2872
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GlacierParser.AS) | (1 << GlacierParser.HIDING) | (1 << GlacierParser.QUALIFIED) | (1 << GlacierParser.EXPORT) | (1 << GlacierParser.STDCALL) | (1 << GlacierParser.CCALL) | (1 << GlacierParser.CAPI) | (1 << GlacierParser.JSCALL) | (1 << GlacierParser.STOCK) | (1 << GlacierParser.ANYCLASS) | (1 << GlacierParser.VIA))) != 0)):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    class QconidContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_qconid
    ...
    def qconid(self):
        ...
        localctx = GlacierParser.QconidContext(self, self._ctx, self.state)
    ...
    class ConidContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_conid
    ...
    def conid(self):
        ...
        localctx = GlacierParser.ConidContext(self, self._ctx, self.state)
    ...
    class QconsymContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_qconsym
    ...
    def qconsym(self):
        ...
        localctx = GlacierParser.QconsymContext(self, self._ctx, self.state)
    ...
    class ConsymContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_consym
    ...
    def consym(self):
        ...
        localctx = GlacierParser.ConsymContext(self, self._ctx, self.state)
    ...
    class LiteralContext(ParserRuleContext):
        ...
        def pchar(self):
            return self.getTypedRuleContext(GlacierParser.PcharContext,0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_literal
    ...
    def literal(self):
        ...
        localctx = GlacierParser.LiteralContext(self, self._ctx, self.state)
        self.enterRule(localctx, 484, self.RULE_literal)
        try:
            self.state = 2906
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [GlacierParser.DECIMAL, GlacierParser.OCTAL, GlacierParser.HEXADECIMAL]:
                self.enterOuterAlt(localctx, 1)
                self.state = 2902
                self.integer()
                pass
            elif token in [GlacierParser.FLOAT]:
                self.enterOuterAlt(localctx, 2)
                self.state = 2903
                self.pfloat()
                pass
            elif token in [GlacierParser.CHAR]:
                self.enterOuterAlt(localctx, 3)
                self.state = 2904
                self.pchar()
                pass
            elif token in [GlacierParser.STRING]:
                self.enterOuterAlt(localctx, 4)
                self.state = 2905
                self.pstring()
                pass
    ...
    class Open_hsContext(ParserRuleContext):
        ...
        def VOCURLY(self):
            return self.getToken(GlacierParser.VOCURLY, 0)

        def OCURLY(self):
            return self.getToken(GlacierParser.OCURLY, 0)

        def getRuleIndex(self):
            return GlacierParser.RULE_open_hs

        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterOpen_hs" ):
                listener.enterOpen_hs(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitOpen_hs" ):
                listener.exitOpen_hs(self)
    ...
    def open_hs(self):
        ...
        localctx = GlacierParser.Open_hsContext(self, self._ctx, self.state)
        self.enterRule(localctx, 486, self.RULE_open_hs)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 2908
            _la = self._input.LA(1)
            if not(_la==GlacierParser.OCURLY or _la==GlacierParser.VOCURLY):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    class CloseContext(ParserRuleContext):
        ...
        def VCCURLY(self):
            return self.getToken(GlacierParser.VCCURLY, 0)

        def CCURLY(self):
            return self.getToken(GlacierParser.CCURLY, 0)

        def getRuleIndex(self):
            return GlacierParser.RULE_close
    ...
    def close(self):
        ...
        localctx = GlacierParser.CloseContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.state = 2910
            _la = self._input.LA(1)
            if not(_la==GlacierParser.CCURLY or _la==GlacierParser.VCCURLY):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    class SemiContext(ParserRuleContext):
        ...
        def Semi(self):
            return self.getToken(GlacierParser.Semi, 0)

        def SEMI(self):
            return self.getToken(GlacierParser.SEMI, 0)

        def getRuleIndex(self):
            return GlacierParser.RULE_semi
    ...
    def semi(self):
        ...
        localctx = GlacierParser.SemiContext(self, self._ctx, self.state)
    ...
    class ModidContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_modid
    ...
    def modid(self):
        ...
        localctx = GlacierParser.ModidContext(self, self._ctx, self.state)
    ...
    class CommasContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_commas
    ...
    def commas(self):
        ...
        localctx = GlacierParser.CommasContext(self, self._ctx, self.state)
        ...
        try:
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not (_la==GlacierParser.Comma):
                    break
    ...
    class BarsContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_bars
    ...
    def bars(self):
        ...
        localctx = GlacierParser.BarsContext(self, self._ctx, self.state)
    ...
    class SpecialContext(ParserRuleContext):
        ...
        def BackQuote(self):
            return self.getToken(GlacierParser.BackQuote, 0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_special
    ...
    def special(self):
        ...
        localctx = GlacierParser.SpecialContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.state = 2934
            _la = self._input.LA(1)
            if not(((((_la - 100)) & ~0x3f) == 0 and ((1 << (_la - 100)) & ((1 << (GlacierParser.Semi - 100)) | (1 << (GlacierParser.Comma - 100)) | (1 << (GlacierParser.BackQuote - 100)) | (1 << (GlacierParser.OpenRoundBracket - 100)) | (1 << (GlacierParser.CloseRoundBracket - 100)) | (1 << (GlacierParser.OpenSquareBracket - 100)) | (1 << (GlacierParser.CloseSquareBracket - 100)) | (1 << (GlacierParser.OCURLY - 100)) | (1 << (GlacierParser.CCURLY - 100)))) != 0)):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    class SymbolContext(ParserRuleContext):
        ...
        def ascSymbol(self):
            return self.getTypedRuleContext(GlacierParser.AscSymbolContext,0)


        def getRuleIndex(self):
            return GlacierParser.RULE_symbol
    ...
    def symbol(self):
        ...
        localctx = GlacierParser.SymbolContext(self, self._ctx, self.state)
    ...
    class AscSymbolContext(ParserRuleContext):
        ...
        def Hash(self):
            return self.getToken(GlacierParser.Hash, 0)

        def Dollar(self):
            return self.getToken(GlacierParser.Dollar, 0)

        def Percent(self):
            return self.getToken(GlacierParser.Percent, 0)

        def Ampersand(self):
            return self.getToken(GlacierParser.Ampersand, 0)

        def Asterisk(self):
            return self.getToken(GlacierParser.Asterisk, 0)

        def Plus(self):
            return self.getToken(GlacierParser.Plus, 0)

        def Dot(self):
            return self.getToken(GlacierParser.Dot, 0)

        def Divide(self):
            return self.getToken(GlacierParser.Divide, 0)

        def Less(self):
            return self.getToken(GlacierParser.Less, 0)

        def Eq(self):
            return self.getToken(GlacierParser.Eq, 0)

        def Greater(self):
            return self.getToken(GlacierParser.Greater, 0)

        def QuestionMark(self):
            return self.getToken(GlacierParser.QuestionMark, 0)
        ...
        def Caret(self):
            return self.getToken(GlacierParser.Caret, 0)
        ...
        def getRuleIndex(self):
            return GlacierParser.RULE_ascSymbol
    ...
    def ascSymbol(self):
        ...
        localctx = GlacierParser.AscSymbolContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.state = 2938
            _la = self._input.LA(1)
            if not(((((_la - 82)) & ~0x3f) == 0 and ((1 << (_la - 82)) & ((1 << (GlacierParser.Hash - 82)) | (1 << (GlacierParser.Less - 82)) | (1 << (GlacierParser.Greater - 82)) | (1 << (GlacierParser.Ampersand - 82)) | (1 << (GlacierParser.Pipe - 82)) | (1 << (GlacierParser.Bang - 82)) | (1 << (GlacierParser.Caret - 82)) | (1 << (GlacierParser.Plus - 82)) | (1 << (GlacierParser.Asterisk - 82)) | (1 << (GlacierParser.Percent - 82)) | (1 << (GlacierParser.Divide - 82)) | (1 << (GlacierParser.Tilde - 82)) | (1 << (GlacierParser.Atsign - 82)) | (1 << (GlacierParser.Dollar - 82)) | (1 << (GlacierParser.Dot - 82)) | (1 << (GlacierParser.QuestionMark - 82)) | (1 << (GlacierParser.Colon - 82)) | (1 << (GlacierParser.Eq - 82)) | (1 << (GlacierParser.ReverseSlash - 82)))) != 0)):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    class IntegerContext(ParserRuleContext):
        ...
        def DECIMAL(self):
            return self.getToken(GlacierParser.DECIMAL, 0)

        def OCTAL(self):
            return self.getToken(GlacierParser.OCTAL, 0)

        def HEXADECIMAL(self):
            return self.getToken(GlacierParser.HEXADECIMAL, 0)

        def getRuleIndex(self):
            return GlacierParser.RULE_integer
    ...
    def integer(self):
        ...
        localctx = GlacierParser.IntegerContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.state = 2940
            _la = self._input.LA(1)
            if not(((((_la - 137)) & ~0x3f) == 0 and ((1 << (_la - 137)) & ((1 << (GlacierParser.DECIMAL - 137)) | (1 << (GlacierParser.OCTAL - 137)) | (1 << (GlacierParser.HEXADECIMAL - 137)))) != 0)):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    class PfloatContext(ParserRuleContext):
        ...
        def FLOAT(self):
            return self.getToken(GlacierParser.FLOAT, 0)

        def getRuleIndex(self):
            return GlacierParser.RULE_pfloat
    ...
    def pfloat(self):
        ...
        localctx = GlacierParser.PfloatContext(self, self._ctx, self.state)
        self.enterRule(localctx, 506, self.RULE_pfloat)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 2942
            self.match(GlacierParser.FLOAT)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
    ...
    class PcharContext(ParserRuleContext):
        ...
        def CHAR(self):
            return self.getToken(GlacierParser.CHAR, 0)

        def getRuleIndex(self):
            return GlacierParser.RULE_pchar
    ...
    def pchar(self):
        ...
        localctx = GlacierParser.PcharContext(self, self._ctx, self.state)
        self.enterRule(localctx, 508, self.RULE_pchar)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 2944
            self.match(GlacierParser.CHAR)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
    ...
    class PstringContext(ParserRuleContext):
        ...
        def STRING(self):
            return self.getToken(GlacierParser.STRING, 0)

        def getRuleIndex(self):
            return GlacierParser.RULE_pstring
    ...
    def pstring(self):
        ...
        localctx = GlacierParser.PstringContext(self, self._ctx, self.state)
